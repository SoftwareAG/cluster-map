import { FetchClient, BasicAuth, ICredentials, Realtime, UserService, TenantService, IAuthentication, CookieAuth } from '@c8y/client';
...
export declare class LoginService {
    ...
    constructor(client: FetchClient, basicAuth: BasicAuth, cookieAuth: CookieAuth, ui: AppStateService, user: UserService, tenant: TenantService, realtime: Realtime, alert: AlertService, api: ApiService, tenantLoginOptionsService: TenantLoginOptionsService, location: LocationStrategy);
    /**
