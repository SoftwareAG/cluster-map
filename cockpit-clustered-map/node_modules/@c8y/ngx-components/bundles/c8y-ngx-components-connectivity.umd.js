(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@c8y/ngx-components'), require('ngx-bootstrap/popover'), require('@c8y/client')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/connectivity', ['exports', '@angular/core', '@angular/forms', '@c8y/ngx-components', 'ngx-bootstrap/popover', '@c8y/client'], factory) :
    (global = global || self, factory((global.c8y = global.c8y || {}, global.c8y['ngx-components'] = global.c8y['ngx-components'] || {}, global.c8y['ngx-components'].connectivity = {}), global.ng.core, global.ng.forms, global.c8y['ngx-components'], global.popover, global.client));
}(this, (function (exports, core, forms, ngxComponents, popover, client) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ConnectivityModule = /** @class */ (function () {
        ...
        ConnectivityModule = __decorate([
            core.NgModule({
                ...
                imports: [ngxComponents.CoreModule, ngxComponents.CommonModule, ngxComponents.FormsModule, popover.PopoverModule, forms.ReactiveFormsModule],
    ...
    exports.ɵa = ImpactConnectivityService;
    exports.ɵb = StatusDisplayComponent;
