import { __spread, __extends, __decorate, __read, __awaiter, __generator, __param, __assign } from 'tslib';
...
var CommonModule = /** @class */ (function () {
    ...
    CommonModule.providers = function () {
        return __spread(DataModule.providers(), [
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.getGreenMinLength = function () {
        ...
        var greenMinLength = Number(get$1(loginOption, 'greenMinLength'));
...
var AppIconComponent = /** @class */ (function () {
    ...
    AppIconComponent.prototype.iconFromAppDefinition = function () {
        ...
        var iconClass = get$1(app, iconClassProperty) || get$1(app, __spread(['manifest'], iconClassProperty));
        return iconClass;
    };
    AppIconComponent.prototype.iconUrlFromAppDefinition = function () {
        var app = this.app || this.options;
        var iconUrlProperty = ['icon', 'url'];
        var iconUrl = get$1(app, iconUrlProperty) || get$1(app, __spread(['manifest'], iconUrlProperty));
        return iconUrl;
    };
...
var DataGridComponent = /** @class */ (function () {
    ...
    Object.defineProperty(DataGridComponent.prototype, "_pagination", {
        set: function (pagination) {
            ...
            var pageSize = get$1(this.pagination, 'pageSize');
            if (pageSize &&
    ...
    DataGridComponent.prototype._getCellRendererSpec = function (_a) {
        ...
        var rendererTemplate = get$1(columnRenderer, (type === 'HEADER' ? 'headerCellRendererDef' : 'cellRendererDef') + ".template");
        ...
        _this.filteringConfig = {
            ...
            getFilter: function (model) {
                ...
                if (model.none) {
                    ...
                    ors.push({
                        __and: map$1(['critical', 'major', 'minor', 'warning'], function (sev) {
                            var zero = {};
...
var DeviceGridService = /** @class */ (function () {
    ...
    DeviceGridService.prototype.getParentsNames = function (device, featuredParentId) {
        ...
        var assetParents = map$1(assetParentsReferences, 'managedObject');
