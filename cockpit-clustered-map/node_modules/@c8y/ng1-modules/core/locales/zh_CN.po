...
msgstr "\"检查用户权限\"部分允许您验证为选定的设备用户授予的权限，这些权限还可以从父设备继承或分配给全局角色。\"授予权限\"部分允许您检查和管理设备的权限。"

msgid "\"{{c8y_Dashboard.name}}\" - dashboard"
msgstr "\"{{c8y_Dashboard.name}}\" - 面板"

msgid "\"{{c8y_Kpi.label}}\" - data point"
msgstr "\"{{c8y_Kpi.label}}\" - 数据点"
...
msgstr "（例如 \"c8y_UnavailabilityAlarm\"。在“设备管理警报”部分的警报详细信息中可以找到警报类型）"

msgid "(file size up to {{ maxFileSizeKB }} KB)"
msgstr "（文件大小最大 {{ maxFileSizeKB }} KB）"
...
msgstr "每个设备 50 MB 存储空间"

msgid "5000 requests per device per month"
msgstr "每个设备每月 5000 次请求"
...
msgstr ""
"<b>读取</b>、<b>创建</b>和<b>更新</b>角色相应允许 READ、CREATE 和 UPDATE 操作。\n"
"<b>管理员</b>角色允许 CREATE、UPDATE 和 DELETE 操作。"

msgid ""
"<b>You are about to delete user \"{{ vm.resolve.user.userName }}\".</b><br>\n"
"  How should subusers be handled?"
msgstr ""
"<b>您即将删除用户 \"{{ vm.resolve.user.userName }}\"。</b><br>\n"
"  应如何处理子用户？"
...
msgstr "<small>多个</small>"

msgid "<small>No</small>"
msgstr "<small>否</small>"

msgid "<small>Single</small>"
msgstr "<small>Single</small>"
...
msgstr "<small>是</small>"

msgid "<span title=\"Two-factor authentication\">TFA</span> settings"
msgstr "<span title=\"Two-factor authentication\">TFA</span> 设置"

msgid "<strong>Created in</strong> {{ d.tenantId }}"
msgstr "已在 {{ d.tenantId }} <strong>中创建</strong>"

msgid "<strong>Created on</strong> {{ d.creationTime | absoluteDate }} <strong>by</strong> {{ d.owner }}"
msgstr "<strong>由</strong> {{ d.owner }} 在 {{ d.creationTime | absoluteDate }} 中<strong>创建</strong>"

msgid "<strong>Created on</strong> {{ d.creationTime | absoluteDate }} <strong>by</strong> {{ d.owner }} <strong>in</strong> {{ d.tenantId }}"
msgstr "<strong>由</strong> {{ d.tenantId }} 的 {{ d.owner }} <strong>于</strong> {{ d.creationTime | absoluteDate }} <strong>创建</strong>"
...
"          inventory."
msgstr ""
"<strong>全局角色</strong>包含普遍适用的权限。例如，\n"
"          选择 \"库存\" 行中的 \"读取\" 将允许具有此角色的用户读取\n"
"          库存中的所有对象。"
...
msgstr "激活此功能将造成设备发送新蜂窝基站 ID 数据时自动更新设备的 GPS 位置。使用此功能会造成附加成本。"
...
msgstr ""
"完成此过程后，您将无法再使用 <b><b>{{ vm.domainName }}</b> 访问租户，\n"
"而需要使用新的域名。\n"
...
msgstr ""
"激活完成后，您将无法再使用 \n"
"{{ vm.domainName }} 访问您的租户，而需要使用新的自定义域名 {{ vm.newDomainName }}。"
...
msgstr ""
"一个<strong>库存角色</strong>包含可附加到设备和\n"
"        设备组的权限。您可以在<a href=\"#/roles\">此处</a>定义自己的库存角色。"
...
"          设备组的权限。<br>\n"
"          单击 <i c8y-icon=\"plus-circle\" class=\"text-primary\"></i> 可添加新权限。\n"
"          在权限下拉列表中，可进一步将访问权限限制到包含\n"
"          所定义类型的对象。"
...
msgstr ""
"将面板应用于类型为\n"
" <i>{{ dashboard.deviceTypeValue }}</i> 的所有设备"
...
msgstr "在“远程访问”选项卡上自动保存第一个连接的主机密钥。"
...
msgstr "请注意，当设备处于飞行模式时，不会执行命令并保持待处理状态，直到关闭飞行模式。"
...
msgstr ""
"下面您可以配置一个或多个 OPC UA 服务器。\n"
"        如果这些服务器已启用并将连接状态设为\"已连接\"，则 OPC UA 代理将会连接到它们。"
...
msgstr "在<a c8y-guide-href=\"users-guide/cockpit/\">此处</a>浏览手册。"
...
msgstr "通过将操作发送到设备，可远程管理资产。举例来说，这包括远程配置、软件更新等。"
...
msgstr "小心！设备 #{source.name} (ID: #{source.id}) 上的温度远高于预期。"

msgid "Cell ID"
msgstr "蜂窝基站 ID"

msgid "Cell ID information activated"
msgstr "已激活蜂窝基站 ID 信息"

msgid "Cell ID information deactivated"
msgstr "已停用蜂窝基站 ID 信息"

msgid "Cell ID usage statistics"
msgstr "蜂窝基站 ID 使用统计信息"
...
msgstr ""
"更改全局角色“设备”可能会导致安全漏洞。例如，如果设备遭到破坏，\n"
"则攻击者可能具有对该平台的扩展访问权限。"
...
msgstr "安装应用程序后单击<strong>下一步</strong>。"
...
msgstr "将您的智能手机连接到 Cumulocity IoT"
...
msgstr "当温度读数超过 100 度时，创建关闭中继操作"
...
msgstr "客户数据更新失败，原因是：{{errorMessage | translate}}。"
...
msgstr "在 1 号 RS232 接口上使用 DDCMP"

msgid "DDCMP on RS232 #2"
msgstr "在 2 号 RS232 接口上使用 DDCMP"
...
msgstr "在 1 号 RS232 接口上使用 DEX"

msgid "DEX on RS232 #2"
msgstr "在 2 号 RS232 接口上使用 DEX"
...
"                  }}."
msgstr ""
"每日：在 {{ schedule.cronConfig.hour | number: '2.0-0' }}:{{\n"
"                    schedule.cronConfig.minute | number: '2.0-0'\n"
"                  }}。"
...
msgstr "数据点：{{config.fragment}} => {{config.series}}"
...
msgstr "设备位置可以由设备本身设置，也可以在平台中手动设置"
...
msgstr "拖动 X 轴可移动时间。<br>选择时段可进行缩放。<br>双击可缩小。"
...
msgstr "来自子租户用户的每个支持用户请求会将支持用户的访问延长指定小时数（默认：24 小时）"
...
msgstr "启用从 UI 更改当前值（例如使用 Fieldbus 小组件）"

msgid "Enable owner"
msgstr "启用所有者"

msgid "Enable showing current value in UI (e.g. on Fieldbus widget)"
msgstr "在 UI 中启用显示当前值（例如在 Fieldbus 小组件上）"
...
msgstr "输入有效的国际电话号码。接受的格式为 +49 9 876 543 210"
...
msgstr "输入以下代码 <code>{{ vm.code }}</code> 以继续："
...
msgstr ""
"请输入 SMS 提供商提供的凭据。这将启用利用\n"
"          SMS 服务的平台功能（例如双重身份验证和用户通知）。"
...
msgstr "\"{{groupName}}\" 组中的 \"{{deviceName}}\" 设备的错误条件已清除。"

msgid "Error conditions triggered on device \"{{deviceName}}\" in group \"{{groupName}}\"."
msgstr "\"{{groupName}}\" 组中的 \"{{deviceName}}\" 设备的错误条件已触发。"
...
msgstr "运行事件处理规则时发生错误。<br>请查看<a href=\"/apps/devicemanagement/#/alarms\">创建的警报</a>，了解详情。"
...
msgstr ""
"特意更改全局角色 \"设备\" 会产生安全漏洞。例如，如果设备\n"
"        被感染，攻击者可能具有凭条的扩展访问权限。"
...
msgstr "基于智能规则的导出计划已被弃用，因此需要进行迁移，但将保留所有设置。是否要继续？"
...
msgstr "未能重新加载配置：\"{{failureReason | translate}}\"."
...
msgstr "未能检索配置快照：\"{{failureReason | translate}}\"."

msgid "Failed to save configuration."
msgstr "保存配置失败。"

msgid "Failed to save configuration: \"{{failureReason | translate}}\"."
msgstr "无法保存配置：\"{{failureReason | translate}}\"."
...
msgstr "找到并安装 <strong>Cumulocity IoT 传感器应用程序</strong>。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"users-guide/administration/#managing-applications\">用户指南</a>中详细了解可用应用程序。"
...
msgstr ""
"在\n"
"            <a c8y-guide-href=\"users-guide/administration/#reprio-alarms\">User guide</a>中详细了解。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"users-guide/cockpit/#smart-rules\">用户指南</a>中详细了解。"
...
msgstr ""
"在\n"
"          <a c8y-guide-href=\"concepts/applications/\">User guide</a>中详细了解。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"users-guide/cockpit/#a-name-add-data-points-a-adding-data-points\">用户指南</a>中详细了解。"
...
msgstr ""
"在\n"
"          <a c8y-guide-href=\"users-guide/cockpit/#dashboards\">User guide</a>中详细了解。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"users-guide/device-management/#simulator\" target=\"_blank\" rel=\"noopener noreferrer\">用户指南</a>中详细了解。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"users-guide/getting-started/\">用户指南</a>中详细了解。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"device-sdk/mqtt/#smartrest-2\">设备 SDK 指南</a>中详细了解。"
...
msgstr ""
"在\n"
"        <a c8y-guide-href=\"reference/retention-rules/\">Reference guide</a>中详细了解。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"users-guide/cockpit/#adding-alarms-or-events\">用户指南</a>中详细了解。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"users-guide/cockpit/#dashboards\">用户指南</a>中详细了解。"
...
msgstr ""
"在\n"
"        <a c8y-guide-href=\"users-guide/cockpit/#export\">User guide</a>中了解更多信息。"
...
msgstr ""
"在\n"
"<a c8y-guide-href=\"users-guide/device-management/#configuration-repository\">用户指南</a>中详细了解。"
...
msgstr ""
"在\n"
"      <a c8y-guide-href=\"users-guide/administration/#event-processing\">User guide</a>中详细了解。"
...
msgstr ""
"在\n"
"      <a c8y-guide-href=\"users-guide/device-management/#simulator\">User guide</a>中详细了解。"
...
msgstr ""
"为实现正确的应用程序行为，您只能使用 {{vm.defaultRedirectUrl}}\n"
"            或 {{vm.host}} 值，建议使用第一个值。"
...
msgstr ""
"有关详细信息，请参阅\n"
"<a c8y-guide-href=\"users-guide/administration/\">用户指南</a>。"

msgid "For device type: {{deviceType}}"
msgstr "对于设备类型：{{deviceType}}"
...
msgstr ""
"为了能够识别占位符，它至少需要在花括号中使用一次，\n"
"且不带其他表达式，例如 <var ng-non-bindable>{{ placeholderName }}</var>。然后，您可以在 Angular 处理的绑定中使用此 placeholderName。\n"
"还有预定义函数可用："
...
msgstr ""
"未找到名称以\n"
"        <strong>{{::vm.filtering.filters.username}}</strong> 开头的设备用户。"
...
msgstr "提供对批量操作和设备管理应用程序的访问，但不包括对任何设备数据的访问。"
...
msgstr "拥有所有已部署 CEP 模块和 SmartRules 的完全访问权限"
...
msgstr ""
"每小时：过去小时的\n"
" {{ schedule.cronConfig.minute | number: '2.0-0' }} 分钟。"
...
msgstr "如果强制实施 OAuth Internal，则基本身份验证不能再用于登录应用程序。旧应用程序可能无法正确显示登录，因此需要更新。"
...
msgstr "如果选择当前设置作为默认值，只要将此数据点添加到数据资源管理器或引用此数据点的现有阈值智能规则，就将使用这些值。"
...
msgstr "必须填写国际电话号码，格式为：+49 9 876 543 210。"
...
msgstr "MAC 地址无效。有效示例：12:34:56:AB:CD:EF"
...
msgstr "库存更新失败，原因是：\"{{failureReason | translate}}\"。"
...
msgstr "最后的群集计算时间：{{lastCalculation | absoluteDate}}"
...
msgstr "最后编辑：{{vm.module.lastModified | absoluteDate}}"
...
msgstr "从库中加载 \"{{ kpi.c8y_Kpi.label }}\""
...
msgstr "正在加载要删除的项目的列表&hellip;"

msgid "Loading users&hellip;"
msgstr "正在加载用户&hellip;"
...
msgstr "主要差异是身份验证信息的存储。使用基本身份验证，将保存在会话存储中，而使用 OAuth 内部，将保存在 HttpOnly Cookie 中。建议授予 OAuth Internal，因为身份验证信息无法通过 JavaScript 访问。"
...
msgstr "最多 25 个字符；仅允许数字、字母、空格和感叹号。"
...
msgstr "可包含小写字母、数字或连字符。必须以字母开头；连字符只能在中间使用；至少 2 个字符。请注意，不建议使用下划线字符，但出于向后兼容的原因，仍然可以使用下划线字符。"
...
msgstr "可包含小写字母、数字、连字符和下划线。必须以字母开头；连字符和下划线只能在中间使用；至少 2 个字符。"
...
msgstr "必须将消息提供商配置为通过 SMS 将 WAN 设置发送到设备"
...
"                  }}."
msgstr ""
"每月：{{ cronService.getMonthDayName(schedule.cronConfig) }} 日期，\n"
"在 {{ schedule.cronConfig.hour | number: '2.0-0' }}:{{\n"
"                    schedule.cronConfig.minute | number: '2.0-0'\n"
"                  }}。"
...
msgstr "未配置 Sigfox 设备类型。请使用设备面板创建一个。"

msgid "No SmartREST templates defined yet."
msgstr "尚未定义 SmartREST 模板。"
...
msgstr "未找到符合 \"{{searchData.lastText}}\" 条件的资产或设备。"
...
msgstr "未配置设备类型。使用设备数据库创建 LoRa 设备类型。"
...
msgstr "未找到包含 <strong>{{ vm.searchString }}</strong> 的文件。"
...
msgstr "请注意，具有较长通信间隔的设备将因不活动而进入睡眠模式。对于处于睡眠模式的设备，在此期间无法执行任何命令。为了使设备退出睡眠模式，您需要将设备放在充电器上。"

msgid "Note that email is required to reset password."
msgstr "请注意，需要电子邮件才能重置密码。"
...
msgstr ""
"注意：选择 \"所有对象\" 选项将同步所有类型的对象，\n"
"                      包括内部对象和技术对象（非独占群组和设备）。\n"
"                      这可能会导致目标租户出现问题。"
...
msgstr "实例数量：{{vm.simulator.instances}}"
...
msgstr ""
"在左侧，可以输入一组 LWM2M shell 命令。每个命令都将发送到每个\n"
"      新注册的 LWM2M 设备。"
...
msgstr "URI 的第一部分仅允许使用小写字母、数字、连字符和下划线。必须以字母开头；连字符和下划线只能在中间使用。必须是有效的 URI。"
...
"            smartphone."
msgstr ""
"打开您智能手机上的 <strong>Google Play Store</strong>\n"
" 或 <strong>Apple App Store</strong>。"
...
msgstr "已触发操作取消。如果正在进行中，可能需要一分钟才能取消。"
...
msgstr "已创建操作：status=\"{{status | translate}}\"。"
...
msgstr "密码必须有至少 {{min}} 个字符，不得超过 {{max}} 个字符，并且只能包含字母、数字和以下符号：`~!@#$%^&*()_|+-=?;:'\",.<>{}[]\\/"
...
msgstr "占位符：{tenant-domain}、{host}、{token}、{email}。例如，重置密码的完整链接可以是：{tenant-domain}/apps/devicemanagement/index.html?token={token}&email={email}"
...
msgstr "占位符：{tenant-domain}、{host}、{token}。例如，设置密码的完整链接可以是：{tenant-domain}/apps/devicemanagement/index.html?token={token}"
...
msgstr "可能值：\"true\"、\"false\"、用户应在截止日期之前激活"
...
msgstr "使用此格式引用另一个对象：/对象/实例/资源，例如 /3303/0/5700"
...
msgstr[0] "总共 {{total}} 个设备中，有 {{$count}} 个设备注册失败。"
...
msgstr ""
"请重试。\n"
"如果不能升级，请<a href=\"mailto:support@cumulocity.com\">联系我们</a>。"
...
msgstr "使用智能手机通过 Google Authenticator 应用程序扫描此二维码。"
...
msgstr "将配置 {{ configurationType }} 发送给设备 {{ deviceName }}"
...
msgstr "正在显示第 {{devices.length}} 个项目"
...
msgstr "不存在 ID 为 \"{{templateId}}\" 的 SmartREST 模板"
...
msgstr "一些条目无效。检查含红色边框的输入字段并至少选择一个数据点。"
...
msgstr ""
"通过指定自动应用约束，您可以限制应用设备类型的范围，\n"
"例如，通过指定一组可能的服务器或节点 ID。"

msgid "Split multiple Bluetooth MAC addresses with \";\""
msgstr "通过 \";\" 拆分多个蓝牙 MAC 地址"
...
msgstr "步骤 <span class=\"badge badge-success\">1</span>/2"

msgid "Step <span class=\"badge badge-success\">2</span> of 2"
msgstr "步骤 <span class=\"badge badge-success\">2</span>（共 2 步）"
...
msgstr "已禁用目标租户中的预订，然后由源租户暂停连接器"
...
msgstr "拿起手机并单击<strong>下一步</strong>。"
...
msgstr "\"{{groupName}}\" 中 \"{{deviceName}}\" 的温度降低了 {{value}}°C。"

msgid "Temperature increased by {{value}}°C on \"{{deviceName}}\" in \"{{groupName}}\"."
msgstr "\"{{groupName}}\" 中 \"{{deviceName}}\" 的温度升高了 {{value}}°C。"
...
msgstr "设备 #{source.name} (id: #{source.id}) 的温度远高于预期。"
...
msgstr ""
"“允许的域”设置将使您的 JavaScript Web 应用程序能够直接与 REST API 通信。\n"
"将其设置为 \"*\" 以允许来自任意主机的通信。\n"
"将其设置为 \"http://my.host.com, http://myother.host.com\" 以允许来自 http://my.host.com 和 http://myother.host.com 的应用程序与平台通信。\n"
"将其留空以仅允许来自租户域的访问。\n"
"参见 http://enable-cors.org，了解更多信息。"
...
msgstr ""
"默认应用程序应用于租户的所有用户。请从下表中选择默认\n"
"          应用程序并确保所有用户都能访问此应用程序。"
...
msgstr ""
"外部 ID 用于链接设备信息和物理环境（例如：序列号、IMEI）。\n"
"\n"
"如因某些原因需更换硬件，还必须用适当的信息替换外部 ID。\n"
"\n"
"通过此程序，新硬件可继续链接到其前身创建的信息。"
...
msgstr "分钟数必须严格小于 60 分钟。间隔时间超过 60 分钟时，请切换为小时。"
...
msgstr ""
"用户将可访问分配的\n"
"          库存角色允许的所列设备组。使用下拉列表可选择应该应用于每个组及\n"
"          其子项的角色。"
...
msgstr ""
"此面板在类型为 \n"
"<i>{{ dashboard.deviceTypeValue }}</i> 的所有设备之间共享。"
...
msgstr ""
"此功能已弃用，将在下一个版本中停用。请改用\n"
"    <a href=\"/apps/devicemanagement/#/simulators\">新模拟器</a>功能。"
...
msgstr ""
"此功能已弃用。尽管此功能仍完全正常运行，但您应使用新的\n"
"    <a href=\"/apps/administration#roles\">角色</a>功能来设置权限。"
...
msgstr "此功能已弃用。尽管此功能仍完全正常运行，但您应使用新的<a href=\"/apps/administration#roles\">角色</a>功能来设置权限。"
...
msgstr "此设置将允许在不付款的情况下检索所有产品。是否确定要激活自由售货？"
...
msgstr ""
"不再支持依赖帐户设置的 Twitter 时间轴小组件（请参阅<a href=\"https://twittercommunity.com/t/deprecating-widget-settings/102295\">公告</a>）。\n"
"相反，您可以使用 HTML 小组件和 <a href=\"https://publish.twitter.com\">Twitter 发布</a>上生成的代码嵌入时间轴。"

msgid "Twitter's username"
msgstr "Twitter 的用户名"

msgid "Twitter's widget ID"
msgstr "Twitter 的小组件 ID"
...
msgstr "使用 DDCMP 列表 2，2 号 RS232 接口"

msgid "Use DDCMP list 2 on RS232 #1"
msgstr "在 1 号 RS232 接口上使用 DDCMP 列表 2"
...
msgstr "在 1 号 RS232 接口上以 2400 传输速率使用增强 DDCMP"
...
"            Sensor App."
msgstr ""
"使用此向导可通过 Cumulocity IoT 传感器应用程序\n"
"将智能手机连接到 Cumulocity IoT。"
...
msgstr ""
"我们将于自\n"
" {{ vm.resolve.contractInfo.NextBillingDate | absoluteDateTimeFormat: 'll' }} 开始的<br>\n"
"下一个开单周期使用提供的信息。"
...
"                  }}."
msgstr ""
"每周：{{ cronService.getWeekDayName(schedule.cronConfig) }}，\n"
"在 {{ schedule.cronConfig.hour | number: '2.0-0' }}:{{\n"
"                    schedule.cronConfig.minute | number: '2.0-0'\n"
"                  }}。"
...
msgstr "欢迎使用 {{vm.appName | humanizeAppName}}"
...
"                  }}."
msgstr ""
"每年：{{ cronService.getMonthName(schedule.cronConfig) }}，\n"
"{{ cronService.getMonthDayName(schedule.cronConfig) }} 日期，\n"
"在 {{ schedule.cronConfig.hour | number: '2.0-0' }}:{{\n"
"                    schedule.cronConfig.minute | number: '2.0-0'\n"
"                  }}。"
...
msgstr ""
"您将要删除 SMS 提供商凭据。\n"
"删除凭据将通过基于 SMS 的双重身份验证锁定所有用户，并停用基于 SMS 的智能规则和设备通信。\n"
"是否要继续？"
...
msgstr "您将要删除数据点 \"{{kpiLabel}}\"。是否要继续？"
...
msgstr "您将要递归删除群组 \"{{name}}\" 及其子组。该操作不可逆。是否要继续？"

msgid "You are about to delete group \"{{name}}\". Do you want to proceed?"
msgstr "您将要删除群组 \"{{name}}\"。是否要继续？"
...
msgstr "您即将删除租户 \"{{company}}\" (ID \"{{id}}\")。是否要继续？"
...
msgstr "您将要从所有 \"{{deviceTypeValue}}\" 类型的设备中删除面板 \"{{name}}\"。是否要继续？"

msgid "You are about to delete the dashboard \"{{name}}\". Do you want to proceed?"
msgstr "您将要删除面板 \"{{name}}\"。是否要继续？"
...
msgstr "您将要编辑全局角色。输入 \"{{ ctrl.randomString }}\" 以确认："
...
"          Do you want to proceed?"
msgstr ""
"您将要加载 {{ temporaryRegistration.timestamp }} 保存的注册数据。\n"
"是否要继续？"
...
msgstr "您将要开始处理软件更改。注意此操作是异步的。是否要继续？"
...
msgstr "您即将暂停租户 \"{{company}}\" (ID \"{{id}}\")。是否要继续？"
...
msgstr "您可以从<a href=\"https://twitter.com/settings/widgets\">小组件设置</a>获取 Twitter 的小组件 ID。"
...
msgstr "您需要以下角色来访问批量操作：批量操作读取/管理员"
...
msgstr "您需要以下角色来管理演示数据：库存读取/管理员、模拟器管理员、智能规则读取/管理员"
...
"        registered."
msgstr ""
"您已达到 {{ vm.limitStatus.limit }} 台设备的限制。无法\n"
"        再注册设备。"
...
msgstr ""
"您已达到 {{ vm.limitStatus.limit }} 台设备的限制。<br>\n"
"        无法再注册设备。<br>\n"
"        请联系您的平台管理员。"
...
msgstr "例如 Joe Doe&amp;Sons Company"
...
msgstr "例如 ModelName，您可以使用星号 (*) 作为通配符"
...
msgstr "例如 https://login.microsoftonline.de"
...
msgstr "失败原因=\"{{failureReason | translate}}\""
...
msgstr ""
"您将 CNAME 条目添加到了 DNS 服务器。\n"
"确保删除通配符域的所有 A 条目。\n"
"如果您的 DNS 服务未提供通配符证书的 CNAME 条目，请联系我们的支持部门"

msgid "you are using a wildcard certificate to enable creation of subtenants"
msgstr "您正在使用通配符证书启用子租户的创建"
