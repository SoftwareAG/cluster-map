...
msgstr "La sección \"Comprobar permisos de usuario\" le permite verificar los permisos concedidos al usuario seleccionado para el dispositivo también heredado de los dispositivos primarios o asignado al rol global. La sección \"Permisos concedidos\" le permite verificar y administrar permisos para el dispositivo."

msgid "\"{{c8y_Dashboard.name}}\" - dashboard"
msgstr "\"{{c8y_Dashboard.name}}\" - cuadro de mando"

msgid "\"{{c8y_Kpi.label}}\" - data point"
msgstr "\"{{c8y_Kpi.label}}\" - punto de datos"
...
msgstr "“{{name}}” - simulador"

msgid "\"{{name}}\" - smart rule"
msgstr "“{{name}}” - regla inteligente"

msgid "\"{{name}}\" - subgroup"
msgstr "\"{{name}}\" - subgrupo"
...
msgstr "&euro; 3 por dispositivo por mes"
...
msgstr "(p. ej. \"c8y_UnavailabilityAlarm\". El tipo de alarma puede encontrarse en los datos de alarma en la sección de alarma dispositivo gestión)"

msgid "(file size up to {{ maxFileSizeKB }} KB)"
msgstr "(tamaño de archivo hasta {{ maxFileSizeKB }} KB)"

msgid "(updated every minute)"
msgstr "(actualización cada minuto)"

msgid "({{paging.more}} left)"
msgstr "({{paging.more}} izquierda)"

msgid "-- device name not defined --"
msgstr "-- nombre de dispositivo no definido --"
...
msgstr[0] "1 nuevo dispositivo"
msgstr[1] "{{$count}} nuevos dispositivos"
...
msgstr[0] "1 instantánea"
msgstr[1] "{{$count}} instantáneas"

msgid "1 tenant"
msgid_plural "{{$count}} tenants"
msgstr[0] "1 inquilino"
msgstr[1] "{{$count}} inquilinos"
...
msgstr "50 MB de almacenamiento por dispositivo"

msgid "5000 requests per device per month"
msgstr "5000 solicitudes por dispositivo por mes"
...
msgstr ""
"<b>Soltar archivo aquí</b><br>\n"
"          o haga clic para buscar en su ordenador."
...
msgstr ""
"Los roles <b>Leer</b>, <b>Crear</b> y <b>Actualizar</b> le permiten LEER, CREAR y ACTUALIZAR\n"
"            respectivamente. Con el rol <b>Administrador</b> puede CREAR, ACTUALIZAR y ELIMINAR."

msgid ""
"<b>You are about to delete user \"{{ vm.resolve.user.userName }}\".</b><br>\n"
"  How should subusers be handled?"
msgstr ""
"<b>Se dispone a eliminar el usuario \"{{ vm.resolve.user.userName }}\".</b><br>\n"
"  ¿Cómo desea gestionar los subusuarios?"

msgid "<em>No description available</em>"
msgstr "<em>Sin descripción disponible</em>"
...
msgstr "<small>Múltiple</small>"

msgid "<small>No</small>"
msgstr "<small>No</small>"

msgid "<small>Single</small>"
msgstr "<small>Individual</small>"
...
msgstr "<small>Sí</small>"

msgid "<span title=\"Two-factor authentication\">TFA</span> settings"
msgstr "Configuración de la <span title=\"Two-factor authentication\">autenticación de dos factores</span>"

msgid "<strong>Created in</strong> {{ d.tenantId }}"
msgstr "<strong>Creado en</strong> {{ d.tenantId }}"

msgid "<strong>Created on</strong> {{ d.creationTime | absoluteDate }} <strong>by</strong> {{ d.owner }}"
msgstr "<strong>Creado el</strong> {{ d.creationTime | absoluteDate }} <strong>por</strong> {{ d.owner }}"

msgid "<strong>Created on</strong> {{ d.creationTime | absoluteDate }} <strong>by</strong> {{ d.owner }} <strong>in</strong> {{ d.tenantId }}"
msgstr "<strong>Creado el</strong> {{ d.creationTime | absoluteDate }} <strong>por</strong> {{ d.owner }} <strong>en</strong> {{ d.tenantId }}"
...
msgstr ""
"<strong>No se han definido filtros de datos.</strong><br>Los filtros de datos definen\n"
"                  el conjunto de datos que se van a reenviar. Debe establecer al menos un filtro."

msgid "<strong>No properties found.</strong> Click below to add the first one."
msgstr "<strong>Ninguna propiedad encontrada.</strong> Haga clic a continuación para agregar una."

msgid ""
"<strong>No validation for this resource.</strong> Add a validation rule by clicking\n"
"            below."
msgstr ""
"<strong>Este recurso no se ha validado.</strong> Agregue una regla de validación haciendo clic\n"
"            aquí abajo."
...
"          inventory."
msgstr ""
"Un <strong>rol global</strong> contiene de manera predeterminada permisos\n"
" aplicables a todos. Seleccione, por ejemplo,\n"
"          \"Leer\" en la fila \"Inventario\" si desea permitir que todos los usuarios con este rol puedan leer todos los objetos del inventario."
...
msgstr ""
"Se ha enviado un SMS de confirmación al número proporcionado en el paso anterior. Antes de\n"
"                finalizar la configuración, asegúrese de que lo ha recibido."
...
msgstr "Gráfico de medida que muestra los valores actuales para las mediciones elegidas"
...
msgstr "Gráfico de medida lineal que muestra los valores actuales para las mediciones elegidas"

msgid "A linear graph displaying values for chosen measurements and time interval (deprecated)"
msgstr "Un gráfico lineal que muestra los valores para las mediciones elegidas y el intervalo de tiempo (obsoleto)"

msgid "A link to existing remote fonts (e.g. Google Fonts)"
msgstr "Un enlace a fuentes remotas existentes (p. ej. Google Fonts)"

msgid "A list displaying current values for chosen measurements"
msgstr "Una lista que muestra los valores actuales para las mediciones elegidas"

msgid "A pie chart displaying current values for chosen measurements"
msgstr "Un gráfico circular que muestra los valores actuales de las medidas seleccionadas"
...
msgstr "Un silo que muestra los valores actuales para las mediciones elegidas"
...
msgstr "ADMITIDO por: {{ackBy}} {{ackTimeFromNow}}"
...
msgstr "ACTIVO: activado {{alarmTimeFromNow}}"
...
msgstr "Acceso a descuentos por volumen"
...
msgstr "Activar regla inteligente \"Enviar cuadro de mando por correo electrónico\""

msgid "Activate Cell ID information"
msgstr "Activar información de ID de celular"
...
msgstr "Si se activa esta funcionalidad se efectúa una actualización automática de la posición GPS del dispositivo al enviar nuevos datos de ID de celular. El uso de esta funcionalidad puede suponer costes adicionales."
...
msgstr "Añadir cuadros de mando Resumen para edificios"

msgid "Add Overview dashboards for simulated devices"
msgstr "Añadir paneles Resumen dispositivos simulados"

msgid "Add SNMP device"
msgstr "Añadir dispositivo SNMP"

msgid "Add SmartREST template"
msgstr "Añadir plantilla SmartREST"

msgid "Add a configuration file"
msgstr "Agregar archivo de configuración"
...
msgstr "Agregar una suscripción de datos haciendo clic a continuación."

msgid "Add a firmware using the button on the toolbar."
msgstr "Añada un firmware usando el botón en la barra de herramientas."

msgid "Add a new mapping by clicking below."
msgstr "Agregar nueva asiganción haciendo clic a continuación."
...
msgstr "Agregar teléfono inteligente"

msgid "Add software"
msgstr "Añadir software"

msgid "Add software using the button on the toolbar."
msgstr "Añadir software utilizando el botón en la barra de herramientas."
...
msgstr "Agregar licencia de inquilino"

msgid "Add tenant option definition"
msgstr "Agregar definición de opción de inquilino"

msgid "Add tenant policy"
msgstr "Añadir política de inquilino"

msgid "Add to group"
msgstr "Agregar al grupo"

msgid "Add to tenant"
msgstr "Añadir al inquilino"
...
msgstr "Añadir widget a cuadro de mando"
...
msgstr "Agregue su primer mapeo de alarmas usando el botón en la barra de herramientas."
...
msgstr "Agregue su primera instantánea de configuración usando el botón en la barra de herramientas."

msgid "Add your first data connector by clicking below."
msgstr "Agregue su primer conector de datos haciendo clic a continuación."
...
msgstr "Añadir su primer grupo o asignar dispositivos utilizando los botones en la barra de herramientas."

msgid "Add your first module by clicking below."
msgstr "Añada su primer módulo haciendo clic a continuación."

msgid "Add your first retention rule by clicking below."
msgstr "Agregue su primera regla de retención haciendo clic a continuación."
...
msgstr ""
"Una vez completado el proceso ya no tendrá acceso a su inquilino con\n"
"      <b>{{ vm.domainName }}</b>. Utilice su nuevo nombre de dominio. En caso de que se produzcan problemas al acceder a su inquilino\n"
"      póngase en contado con el soporte técnico."
...
msgstr ""
"Una vez concluido el proceso, ya no podrá acceder a su inquilino con el\n"
"      nombre de dominio personalizado. Utilice su nombre de dominio antiguo. Póngase en contacto con su soporte técnico\n"
"      si se produce algún problema al acceder a su inquilino."
...
msgstr ""
"Una vez completada la activación no podrá volver acceder a su inquilino con el nombre\n"
"            {{ vm.domainName }}, en vez de éste utilice su nuevo nombre de dominio personalizado {{ vm.newDomainName }}."
...
msgstr "Modo avión activado. Por favor coloque su dispositivo en el cargador para conectarlo."

msgid "Alarm"
msgstr "Alarma"

msgid "Alarm / event type"
msgstr "Alarma / evento tipo"
...
msgstr "El mapeo de alarmas transforma automáticamente la descripción y la gravedad basada en la coincidencia del tipo de alarma. Los tipos de alarma son una propiedad definida de cada alarma creada en la plataforma."
...
msgstr "Todos los dispositivos procesados correctamente."
...
msgstr "Permiten la creación de subinquilinos"

msgid "Allow insecure use of elements and attributes"
msgstr "Permitir el uso inseguro de elementos y atributos"

msgid "Allow subtenants to edit this retention rule"
msgstr "Permitir a los subinquilinos editar esta regla de retención"

msgid "Allow subtenants to edit this system option"
msgstr "Permitir que los subinquilinos editen esta opción de sistema"

msgid "Allow subtenants to edit this tenant option"
msgstr "Permitir a los subinquilinos editar esta opción"

msgid "Allow two-factor authentication"
msgstr "Permitir la autenticación de dos factores"
...
msgstr ""
"Permite al usuario configurar una jerarquía de grupos, simuladores, cuadros de mandos y reglas inteligentes en un inquilino,\n"
"          además de simular condiciones normales y de error."

msgid "Also delete all devices inside this group and its sub-groups."
msgstr "También borra todos los dispositivos dentro de este grupo y sus subgrupos."
...
msgstr ""
"Un <strong>rol de inventario</strong> contiene permisos que pueden conectarse a dispositivos y\n"
"        grupos de dispositivos. Puede definir sus roles de inventario propios <a href=\"#/roles\">aquí</a>."
...
"          defined type."
msgstr ""
"Un <strong>rol de inventario</strong> contiene permisos que se pueden anexar a grupos de\n"
"          dispositivos.<br>\n"
"          Haga clic en <i c8y-icon=\"plus-circle\" class=\"text-primary\"></i> para agregar un permiso nuevo. En la\n"
"          lista desplegable de permisos puede restringir aún más el acceso a objetos que contienen el\n"
"          tipo definido."
...
msgstr "Ha ocurrido un error durante el proceso de actualización"
...
msgstr "La aplicación \"{{appName | humanizeAppName}}\" es ahora la aplicación predeterminada para el inquilino."
...
msgstr "La aplicación con los valores ({{valuesList}}) ya existe para el inquilino \"{{tenant}}\"."
...
msgstr "Clave de sesión de aplicación"
...
msgstr "Aplicaciones propiedad <br> por su inquilino"

msgid "Applications owned by your tenant"
msgstr "Aplicaciones propiedad de su inquilino"
...
msgstr "Aplicar instantánea de configuración"

msgid "Apply dashboard to all devices of type"
msgstr "Aplicar cuadro de mando a todos los dispositivos del tipo"

msgid ""
"Apply dashboard to all devices of type\n"
"                    <i>{{ dashboard.deviceTypeValue }}</i>"
msgstr ""
"Aplicar cuadro de mando a todos los dispositivos del tipo\n"
"                    <i>{{ dashboard.deviceTypeValue }}</i>"
...
msgstr "Aplicar nuevas instantánea"

msgid "Apply the selected action to the group of checked rows"
msgstr "Aplicar la acción seleccionada al grupo de filas marcadas"
...
msgstr "¿Desea realmente desactivar la información de ID de celular en este dispositivo?"

msgid "Are you sure you want to delete tenant policy \"{{name}}\"?"
msgstr "¿Desea realmente eliminar la política de inquilino \"{{name}}\"?"
...
msgstr "Matriz de retransmisiones"
...
msgstr "Aplicar restricciones automáticamente"
...
msgstr "Clave de host de guardado automático"

msgid "Auto save host key on first connection on Remote access tab."
msgstr "Clave de host para el guardado automático al conectarse por primera vez mediante la pestaña de acceso remoto."
...
msgstr "Detección automática en marcha."
...
msgstr "Nivel de batería inferior al 20%"

msgid "Battery life approx. 10 days"
msgstr "Duración de la batería aprox. 10 días"

msgid "Battery life approx. 10-15 hours"
msgstr "Duración de la batería aprox. 10-15 horas"

msgid "Battery life approx. 15 days"
msgstr "Duración de la batería aprox. 15 días"

msgid "Battery life approx. 20 days"
msgstr "Duración de la batería aprox. 20 días"

msgid "Battery life approx. 30 days"
msgstr "Duración de la batería aprox. 30 dias"

msgid "Battery life approx. 40 days"
msgstr "Duración de la batería aprox. 40 días"

msgid "Battery: level"
msgstr "Batería: nivel"
...
msgstr "Tenga en cuenta que cuando un dispositivo está en modo de vuelo, los comandos no se ejecutan y permanecen pendientes hasta que se desactive el modo de vuelo."
...
msgstr ""
"Aquí puede configurar uno o más servidores OPC UA. El agente OPC UA conectará con estos\n"
"        servidores si están funcionando y si el estado de conexión se ha definido de tal modo: \"conectado\"."

msgid "Beware not to lock yourself out of the platform."
msgstr "Tenga cuidado de no bloquearse fuera de la plataforma."

msgid "Bill validator"
msgstr "Validador de billetes"
...
msgstr "Direcciones MAC Bluetooth"
...
msgid "Branded"
msgstr "Con identidad de marca"

msgid "Branded applications creation process completed."
msgstr "Proceso de creación de aplicaciones con identidad de marca completo."

msgid "Branded applications creation process started."
msgstr "Proceso de creación de aplicaciones con identidad de marca iniciado."
...
msgstr "Configuración de identidad aplicada."
...
msgstr "Examine el manual <a c8y-guide-href=\"users-guide/cockpit/\">aquí</a>."

msgid "Building {{number}}"
msgstr "Edificio {{number}}"

msgid "Built-in"
msgstr "Integrado"

msgid "Bulk device registration"
msgstr "Registro de dispositivos masivos"
...
msgstr "Operación en masa actualizada."
...
msgstr ""
"Al mostrar el código QR proporciona acceso a los datos de su cuenta. Le recomendamos que\n"
"          use esta funcionalidad sólo con cuentas de demostración."
...
msgstr "BORRADO: estaba activo para {{alarmDuration}}"
...
msgstr "Calcula el consumo de energía"

msgid "Camera type"
msgstr "Tipo de cámara"

msgid "Can access and modify the full user hierarchy"
msgstr "Puede acceder y modificar toda la jerarquía de usuario"

msgid "Can create new user as his own sub-users and manage this"
msgstr "Puede crear un nuevo usuario como sus propios sub-usuarios y administrar este"

msgid "Can manage tenant wide configurations like applications, tenant options and retention rules"
msgstr "Puede administrar amplias configuraciones de inquilino como aplicaciones, opciones de inquilino y reglas de retención"
...
msgstr "Puede leer todos los datos del activo y administrar todos los datos de inventario, pero no puede realizar operaciones. También puede reconocer y borrar alarmas. Puede crear y actualizar cuadros de mando."
...
msgstr "Puede leer y escribir toda la información de todos los dispositivos"
...
msgstr "Puede administrar remotamente los activos enviando operaciones al dispositivo. Esto incluye, por ejemplo, configuración remota, actualización de software, etc."
...
msgstr "Cancelar todas las operaciones pendientes"
...
msgstr "Cancelación de operaciones pendientes"
...
msgstr "No se puede agregar grupo como su propio secundario."
...
msgstr "No se puede actualizar/borrar binario de aplicación a través de este punto final"
...
msgstr "¡Atención! La temperatura medida en el dispositivo #{source.name} (ID: #{source.id}) es mucho más elevada de lo permitido."

msgid "Cell ID"
msgstr "ID de celular"

msgid "Cell ID information activated"
msgstr "Información de ID de celular activada"

msgid "Cell ID information deactivated"
msgstr "Información de ID de celular desactivada"

msgid "Cell ID usage statistics"
msgstr "Estadística de uso de ID de celular"
...
msgstr "Cambiar la gravedad de las alarmas en función del tiempo de actividad"
...
msgstr ""
"Cambiar el rol global \"dispositivos\" puede crear una brecha de seguridad. P. ej., si un dispositivo\n"
...
msgstr "Comprobar todo visible"

msgid "Check for the existence of \"{{fragmentPath}}\" fragment"
msgstr "Comprobar si existe el fragmento \"{{fragmentPath}}\""

msgid "Check if TCS:BUS plugin enabled"
msgstr "Compruebe si TCS: BUS plugin habilitado"
...
msgstr "Borrar todas las casillas de verificación"
...
msgstr "Borrar la situación de error"
...
msgstr "Haga clic en <strong>Siguiente</strong> una vez instalada la aplicación."
...
msgstr "Haga clic a continuación para agregar su primera política de inquilino."

msgid "Click below to create your first tenant."
msgstr "Haga clic abajo para crear su primer inquilino."
...
msgstr "Implementación de Cloud SaaS"
...
msgstr "El nombre de encabezado de columna debe ser único"

msgid "Columns definitions saved."
msgstr "Definiciones de columna guardadas."

msgid "Comma-separated list of application names"
msgstr "Lista de nombres de aplicación separados por comas"
...
msgstr "Intervalo de comunicación"
...
msgstr "Puerta de configuración"
...
msgstr "Instantánea de configuración aplicada."

msgid "Configuration snapshot file"
msgstr "Archivo de instantánea de configuración"

msgid "Configuration snapshot saved to configuration repository."
msgstr "La instantánea de configuración se ha guardado en el depósito de configuración."

msgid "Configuration snapshot saved."
msgstr "Instantánea de configuración guardada."

msgid "Configuration snapshot will be applied."
msgstr "La instantánea de configuración se aplicará."

msgid "Configuration snapshot will be retrieved."
msgstr "Ahora obtendrá la configuración de la instantánea."

msgid "Configuration snapshots repository"
msgstr "Depósito de instantáneas de configuración"
...
msgstr "La solicitud de actualización de la configuración se ha enviado al dispositivo."
...
msgstr "Configurar reglas inteligentes"

msgid "Configure the Starter kit device: OBU-GT."
msgstr "Configurar el dispositivo de kit de arranque: OBU-GT."

msgid "Configure your own processing rules and actions."
msgstr "Configure sus propias reglas y acciones de proceso."

msgid "Configuring Starter kit device"
msgstr "Configuración de dispositivo de kit de arranque"
...
msgstr "Confirmar la cancelación de todas las operaciones pendientes"

msgid "Confirm cancelling operation?"
msgstr "¿Confirmar la cancelación de la operación?"
...
msgstr "¿Confirmar entrando en modo avión?"
...
msgstr "Credenciales de conectividad actualizadas correctamente."
...
msgstr "El conector no se inicia pero se suspende por el inquilino de origen"

msgid "Connector not bootstrapped yet"
msgstr "Conector no iniciado todavía"

msgid "Connector saved."
msgstr "Conector guardado."

msgid "Connector suspended by source tenant"
msgstr "Conector suspendido por origen del inquilino"
...
msgstr "Cuadro de mando de contexto"
...
msgstr "Control de modo avión por OBU-GT."
...
msgstr "Controles de acceso a las medidas."
...
msgid "Copy inventory roles from…"
msgstr "Copiar roles de inventario de…"

msgid "Copy roles from…"
msgstr "Copiar roles desde…"
...
msgstr "El inquilino no ha podido crearse. El inquilino con el dominio y URL indicados ya existe."

msgid "Could not create application."
msgstr "La aplicación no ha podido crearse."

msgid "Could not delete application assigned to other tenants."
msgstr "La aplicación asignada a otros inquilinos no ha podido eliminarse."
...
msgstr "No se puede ejecutar la operación en masa en un grupo vacío. El grupo con el ID \"{{groupId}}\" no tiene recursos secundarios."

msgid "Could not execute bulk operation on an empty group. Smart group with ID \"{{groupId}}\" has no child assets."
msgstr "No se puede ejecutar la operación en masa en un grupo vacío. El grupo inteligente con el ID \"{{groupId}}\" no tiene recursos secundarios."

msgid "Could not fetch the file."
msgstr "El archivo no ha podido capturarse."
...
msgstr "No se ha podido iniciar la encuesta de medición."
...
msgstr "La configuración de OAuth 2.0 no ha podido cargarse."
...
msgstr "El URL no ha podido abrirse: {{url}}."
...
msgstr "El inquilino \"{{tenant}}\" no ha podido eliminarse. Quite primero sus subinquilinos."
...
msgstr[0] "Crear subgrupo de edificio"
msgstr[1] "Crear subgrupos de edificios"

msgid "Create CRITICAL alarm"
msgstr "Crear alarma CRÍTICA"

msgid "Create IIoT demo"
msgstr "Crear IIoT demo"
...
msgstr "Crear alarma en caso de que la temperatura sea demasiado baja durante 15 minutos"

msgid "Create alarm on not processed operation"
msgstr "Crear alarma en la operación no procesada"
...
msgstr "Crear alarma cuando la temperatura esté por debajo de 0 grados"

msgid "Create alarm when temperature over 100 degree"
msgstr "Crear alarma cuando la temperatura esté sobre 100 grados"
...
msgstr "Crear retransmisión de cierre cuando las lecturas de la temperatura estén sobre 100 grados"
...
msgstr "Crear cuadro de mando"

msgid "Create device"
msgstr "Crear dispositivo"

msgid "Create error situation"
msgstr "Crear situación de error"

msgid "Create global role"
msgstr "Crear rol global"
...
msgstr[1] "Crear grupo con {{$count}} dispositivos"
...
msgstr "Crear o importar su primera plantilla SmartREST."
...
msgstr "Crear dispositivos simulados"
...
msgstr[0] "Crear grupo de centro de nivel superior"
msgstr[1] "Crear grupos de centro de nivel superior"

msgid "Create widget"
msgstr "Crear widget"

msgid "Create your first Simulator."
msgstr "Cree su primer Simulador."

msgid "Create your first device protocol by clicking below"
msgstr "Crear su primer protocolo de dispositivo haciendo clic a continuación"
...
msgstr "Crea alarma cuando las medidas están perdidas"
...
msgstr ""
"Las credenciales ya se han proporcionado. <br>\n"
"          Haga clic aquí abajo en \"Reemplazar credenciales\" para sobrescribirlas."

msgid "Credentials deleted."
msgstr "Las credenciales se han eliminado correctamente."

msgid "Credentials saved."
msgstr "Las credenciales se han guardado correctamente."
...
msgstr ""
"Plataforma IoT de Cumulocity <br>\n"
...
msgstr "Actualmente en la edición de prueba, actualice para establecer un método de pago."

msgid "Custom"
msgstr "Personalizar"

msgid "Custom Superhero Header"
msgstr "Encabezado de superhéroe personalizado"
...
msgstr "Cuadro de mando personalizado"

msgid "Custom device registration"
msgstr "Registro del dispositivo personalizado"
...
msgstr "Tipo de operación personalizada"
...
msgstr "Los datos de cliente no han podido actualizarse debido a: {{errorMessage | translate}}."

msgid "Customer data update failed."
msgstr "La actualización de datos de cliente no ha podido efectuarse."

msgid "Customer data updated."
msgstr "Datos de cliente actualizados."

msgid "Customize widget style"
msgstr "Personalizar estilo de widget"
...
msgstr "DDCMP en RS232 #1"

msgid "DDCMP on RS232 #2"
msgstr "DDCMP en RS232 #2"
...
msgstr "DEX en RS232 #1"

msgid "DEX on RS232 #2"
msgstr "DEX en RS232 #2"
...
"                  }}."
msgstr ""
"Por día: a las {{ schedule.cronConfig.hour | number: '2.0-0' }}:{{\n"
"                    schedule.cronConfig.minute | number: '2.0-0'\n"
"                  }}."
...
msgstr "Tema del cuadro de mando"

msgid "Dashboard visible to all users"
msgstr "Cuadro de mando visible para todos los usuarios"
...
msgstr "El procesamiento de broker de datos no puede conectar con el inquilino de destino, la transmisión de datos no funciona correctamente. Póngase en contacto con el soporte técnico."
...
msgstr "Punto de datos eliminado."

msgid "Data point for gauge"
msgstr "Punto de datos para el medidor"

msgid "Data point for labels"
msgstr "Punto de datos para etiquetas"
...
msgstr "Punto de datos: {{config.fragment}} => {{config.series}}"
...
msgstr "Widget de perfil de datos"
...
msgstr "Desactivar información de ID de celular"

msgid "Deactivate MDB sniffer mode"
msgstr "Desactivar modo MDB sniffer"
...
msgstr "Si desactiva el acceso al soporte como administrador de inquilino desactivará también otras solicitudes de soporte en su inquilino."
...
msgstr "Aplicaciones predeterminadas para nuevos inquilinos"
...
msgstr "Eliminar asignación de alarmas"

msgid "Delete all subusers"
msgstr "Borrar todos de subusuarios"
...
msgstr "Eliminar configuración actual"
...
msgstr "Eliminar elemento de software"

msgid "Delete subscription"
msgstr "Eliminar suscripción"

msgid "Delete tenant"
msgstr "Eliminar inquilino"

msgid "Delete tenant policy"
msgstr "Eliminar política de inquilino"
...
msgstr "Eliminando elementos&hellip;"
...
msgstr "Datos de demostración creados."

msgid "Demo data deleted."
msgstr "Datos de demostración eliminados."
...
msgstr "ID de dispositivo es necesaria."
...
msgstr "El firmware de dispositivo se actualizará."

msgid "Device found for identity {{type}}: {{externalId}}."
msgstr "Dispositivo encontrado para la identidad {{type}}: {{externalId}}."

msgid "Device grid"
msgstr "Cuadrícula de dispositivo"
...
msgstr "El Dispositivo está ahora avión."

msgid "Device is offline"
msgstr "El dispositivo está desconectado"

msgid "Device is ready to receive commands"
msgstr "Dispositivo está listo para recibir comandos"
...
msgstr "La ubicación del dispositivo puede ser configurada por el propio dispositivo, o manualmente en la plataforma"
...
msgstr "Operaciones de dispositivos"
...
msgstr "Tipo de protocolo de dispositivo"

msgid "Device protocol updated"
msgstr "Actualización del protocolo del dispositivo"
...
msgstr "Dispositivos relacionados con la información de registro aparecerá en \"<b>eventos</b>\"."
...
msgstr "El software de dispositivo se actualizará."

msgid "Device status"
msgstr "Estado del dispositivo"

msgid "Device support service"
msgstr "Servicio de soporte de dispositivo"
...
msgstr[0] "El dispositivo se conectará."
msgstr[1] "{{$count}} dispositivos se conectarán."

msgid "Device will be disconnected."
msgstr "El dispositivo se desconectará."

msgid "Device will be restarted."
msgstr "El dispositivo se reiniciará."

msgid "Device with the same address already exists."
msgstr "Un dispositivo con la misma dirección ya existe."

msgid "Device {{id}}"
msgstr "Dispositivo {{id}}"

msgid "Device {{id}} registered."
msgstr "Dispositivo {{id}} registrado."
...
msgstr "Gestión de dispositivos de usuario"

msgid "Devices"
msgstr "Dispositivos"

msgid "Devices scanned and connected."
msgstr "Dispositivos escaneados y conectados."

msgid "Devices will be scanned and connected."
msgstr "Los dispositivos se escanearán y se conectarán."
...
msgstr "Desconectar dispositivos secundarios."
...
msgstr "Mostrar una imagen de la computadora del usuario."
...
msgstr "Muestra una lista de filtrado por objeto, severidad y estado de alarmas"
...
msgstr "Muestra líneas de seguimiento del dispositivo de seguimiento con funcionalidad de reproducción"

msgid "Displays tweets from Twitter's embedded timeline widget"
msgstr "Muestra tweets del widget de calendario integrado de Twitter"

msgid "Divisor"
msgstr "Divisor"

msgid "Do not wake device automatically"
msgstr "No despertar el dispositivo automáticamente"

msgid "Do you really want to cancel all pending operations?"
msgstr "¿Realmente desea cancelar todas las operaciones pendientes?"

msgid "Do you really want to cancel operation \"{{description | translate}}\"?"
msgstr "¿Realmente desea cancelar la operación \"{{description | translate}}\"?"
...
msgstr "¿Realmente desea cancelar esta operación?"
...
msgstr "¿Desea realmente los datos de demostración?"
...
msgstr "El nombre de dominio ya está siendo utilizado por otro inquilino."
...
"        adjust."
msgstr ""
"Haga doble clic para añadir puntos y ajustar el área. Haga clic y arrastre\n"
...
msgstr "Descargar lista de correos para usuarios suscritos al boletín en el inquilino actual y sus subinquilinos."
...
msgstr "Arrastre el X-Axis para mover el tiempo. <br> Seleccione el período de tiempo para ampliar. <br> Haga doble clic para alejar el zoom."
...
msgstr "Todas las solicitudes de usuario de soporte procedentes del usuario de un subinquilino prolongarán el acceso al soporte durante un número determinado de horas (por defecto: 24 horas)"
...
msgstr "Editar plantilla de comando"
...
msgstr "Editar configuración de punto de datos"
...
msgstr "Editar planificación operativa"

msgid "Edit payment method"
msgstr "Editar método de pago"
...
msgstr "Permiten cambiar el valor actual de interfaz de usuario (por ejemplo usando el widget Fieldbus)"
...
msgstr "Activar/desactivar el plugin de TCS:BUS"
...
msgstr "Final del período de prueba"
...
msgstr "Medida del consumo de energía:"

msgid "Enforce \"green\" passwords for all users"
msgstr "Hacer cumplir las contraseñas \"verdes\" para todos los usuarios"

msgid "Enforce OAuth Internal"
msgstr "Aplicar OAuth Internal"

msgid "Enforce TOTP two-factor authentication on all users"
msgstr "Aplicar autenticación de dos factores TOTP a todos los usuarios"

msgid "Enforce that all passwords are \"strong\" (green)"
msgstr "Exigir que todas las contraseñas sean \"fuertes” (verde)"
...
msgstr "Introduzca un número válido de teléfono internacional. Formato aceptado es + 49 9 876 543 210"

msgid "Enter a valid international phone number. The accepted format is +49 9 876 543 210."
msgstr "Introduzca un número válido de teléfono internacional. El formato aceptado es + 49 9 876 543 210."

msgid "Enter address"
msgstr "Ingrese la dirección"

msgid "Enter airplane mode"
msgstr "Entrar en modo avión"
...
msgstr "Introduzca el fragmento inicial de identificación del dispositivo o el nombre para buscar"

msgid "Enter the following code <code>{{ vm.code }}</code> to proceed:"
msgstr "Introduzca el código siguiente <code>{{ vm.code }}</code> para continuar:"

msgid "Enter the name of the Superhero"
msgstr "Introduzca el nombre del superhéroe"

msgid "Enter the special ability of the Superhero"
msgstr "Introduzca la habilidad especial del superhéroe"
...
msgstr ""
"Introduzca las credenciales de su proveedor de SMS. Esto activa funciones de la plataforma que usan\n"
"          servicios de SMS (p. ej., la autenticación de dos factores y las notificaciones de usuario)."

msgid "Enterprise Tenant"
msgstr "Inquilino de empresa"
...
msgstr "Condiciones de error borradas en el dispositivo \"{{deviceName}}\" en el grupo \"{{groupName}}\"."

msgid "Error conditions triggered on device \"{{deviceName}}\" in group \"{{groupName}}\"."
msgstr "Condiciones de error desencadenadas en el dispositivo \"{{deviceName}}\" en el grupo \"{{groupName}}\"."
...
msgstr "Detalles de la mensaje de error"
...
msgstr "Se ha producido error: {{message}}"
...
msgstr "Se han producido errores durante la ejecución de reglas de procesamiento de evento. <br> Compruebe las <a href=\"/apps/devicemanagement/#/alarms\">alarmas creadas</a> si desea obtener más detalles."
...
msgstr "Procesamiento de eventos"

msgid "Event processing rules"
msgstr "Reglas de procesamiento de evento"

msgid "Event processing rules examples"
msgstr "Ejemplos de reglas de procesamiento de evento"
...
msgstr "Excepción en el inquilino {{tenantId}} en la sentencia \"{{moduleName}}\": Excepción de invocación al invocar el método \"{{methodName}}\" de la clase \"{{classPath}}\" paso de parámetros [{{parameters}}] para la sentencia \"{{statement}}\": {{exceptionType}} : {{exceptionMessage}}."

msgid "Exception on tenant {{tenantId}} in statement \"{{statement}}\": HTTP status code: {{httpStatusCode}} : {{message | translate}}"
msgstr "Excepción en el inquilino {{tenantId}} en la declaración \"{{statement}}\": Código de estado HTTP: {{httpStatusCode}} : {{message | translate}}"
...
msgstr "Valor de destino esperado para el punto de datos"
...
msgstr "Los horarios de exportación basados en reglas inteligentes están pasados de fecha y es necesario migrarlos. Sin embargo la configuración se conservará. ¿Desea continuar?"
...
msgstr "La aplicación no ha podido activarse"

msgid "Failed to add new child device."
msgstr "Error al agregar nuevo dispositivo secundario."

msgid "Failed to apply configuration snapshot."
msgstr "La instantánea de configuración no ha podido aplicarse."

msgid "Failed to apply configuration snapshot: \"{{failureReason | translate}}\"."
msgstr "La instantánea de configuración no ha podido aplicarse: \"{{failureReason | translate}}\"."

msgid "Failed to apply configuration."
msgstr "La configuración no ha podido aplicarse."

msgid "Failed to apply configuration: \"{{failureReason | translate}}\"."
msgstr "La configuración no ha podido aplicarse: \"{{failureReason | translate}}\"."

msgid "Failed to change child device."
msgstr "Error al cambiar dispositivo secundario."
...
msgstr "El valor no ha podido cambiarse de {{name}} a {{value}}{{unit}}"
...
msgstr "La retrasmisión no ha podido cerrarse."

msgid "Failed to connect using given credentials."
msgstr "No ha podido conectarse con las credenciales indicadas."

msgid "Failed to disconnect SIM card from the session."
msgstr "La tarjeta SIM no ha podido desconectarse de la sesión."

msgid "Failed to disconnect device."
msgstr "El dispositivo no ha podido desactivarse."
...
msgstr "La retrasmisión no ha podido abrirse."
...
" Click \"Show details\" to get more information."
msgstr[0] ""
"Uno de los dispositivos no ha podido procesarse.\n"
" Haga clic en \"Mostrar detalles\" para obtener más información."
msgstr[1] ""
"{{$count}} dispositivos no han podido procesarse.\n"
" Haga clic en \"Mostrar detalles\" para obtener más información."

msgid "Failed to register a smartphone."
msgstr "El teléfono inteligente no ha podido registrarse."

msgid "Failed to register device."
msgstr "Fallo al registrar el dispositivo."

msgid "Failed to reload configuration."
msgstr "Error al volver a cargar la configuración."

msgid "Failed to reload configuration: \"{{failureReason | translate}}\"."
msgstr "La configuración no ha podido volver a cargarse: \"{{failureReason | translate}}\"."

msgid "Failed to retrieve RDB snapshot."
msgstr "La instantánea RDB no ha podido recuperarse."
...
msgstr "La instantánea de configuración no ha podido recuperarse."

msgid "Failed to retrieve configuration snapshot: \"{{failureReason | translate}}\"."
msgstr "La instantánea de configuración no ha podido recuperarse: \"{{failureReason | translate}}\"."

msgid "Failed to save configuration."
msgstr "La configuración no ha podido guardarse."

msgid "Failed to save configuration: \"{{failureReason | translate}}\"."
msgstr "La configuración no ha podido guardarse: \"{{failureReason | translate}}\"."

msgid "Failed to save. Try again."
msgstr "No ha podido guardarse. Vuelva a intentarlo."

msgid "Failed to scan and connect devices."
msgstr "Los dispositivos no han podido escanearse ni conectarse."

msgid "Failed to update domain at the platform."
msgstr "No se pudo actualizar el dominio en la plataforma."
...
msgstr "Filtrar dispositivos por grupo"
...
msgstr "Busque e instale la aplicación <strong>Cumulocity IoT Sensor</strong>."

msgid "Find by external ID"
msgstr "Buscar por ID externa"
...
msgstr ""
"Consulte el manual\n"
"  <a c8y-guide-href=\"users-guide/administration/#managing-applications\">User guide</a> si desea obtener más información al respecto."
...
msgstr ""
"Consulte el manual\n"
"            <a c8y-guide-href=\"users-guide/administration/#reprio-alarms\">User guide</a> si desea obtener más información al respecto."
...
msgstr ""
"Consulte el manual\n"
"            <a c8y-guide-href=\"users-guide/cockpit/#smart-rules\">User guide</a> si desea obtener más información al respecto."
...
msgstr ""
"Consulte el manual\n"
"          <a c8y-guide-href=\"users-guide/cockpit/#a-name-add-data-points-a-adding-data-points\">User guide</a> si desea obtener más información al respecto."
...
msgstr ""
"Consulte el manual\n"
"          <a c8y-guide-href=\"users-guide/cockpit/#dashboards\">User guide</a> si desea obtener más información al respecto."
...
msgstr ""
"Consulte el manual\n"
"          <a c8y-guide-href=\"users-guide/device-management/#simulator\" target=\"_blank\" rel=\"noopener noreferrer\">User guide</a> si desea obtener más información al respecto."
...
msgstr ""
"Consulte el manual\n"
"          <a c8y-guide-href=\"users-guide/getting-started/\">User guide</a> si desea obtener más información al respecto."
...
msgstr ""
"Consulte el maual\n"
"        <a c8y-guide-href=\"device-sdk/mqtt/#smartrest-2\">Device SDK guide</a>si desea obtener más información al respecto."
...
msgstr ""
"Consulte el manual\n"
"        <a c8y-guide-href=\"reference/retention-rules/\">Reference guide</a> si desea obtener más información al respecto."
...
msgstr ""
"Consulte el manual\n"
"        <a c8y-guide-href=\"users-guide/cockpit/#adding-alarms-or-events\">User guide</a> si desea obtener más información al respecto."
...
msgstr ""
"Consulte el manual\n"
"        <a c8y-guide-href=\"users-guide/cockpit/#export\">User guide</a> si desea obtener más información al respecto."
...
msgstr ""
"Consulte el manual\n"
"        <a c8y-guide-href=\"users-guide/device-management/#configuration-repository\">User guide</a> si desea obtener más información al respecto."
...
msgstr ""
"Consulte el manual\n"
"      <a c8y-guide-href=\"users-guide/administration/#event-processing\">User guide</a> si desea obtener más información al respecto."
...
msgstr ""
"Consulte el manual\n"
"      <a c8y-guide-href=\"users-guide/device-management/#simulator\">User guide</a> si desea obtener más información al respecto."
...
"      to get more information."
msgstr ""
"Consulte su archivo de registro en las\n"
"      <a c8y-guide-href=\"devices/overview/\">Device guides</a>\n"
"      si desea obtener más información al respecto."
...
msgstr "Elemento de firmware eliminado."

msgid "Firmware item saved."
msgstr "Elemento de firmware guardado."

msgid "Firmware repository"
msgstr "Depósito de firmware"

msgid "Firmware to install"
msgstr "Firmware para instalar"
...
"            Make sure that:"
msgstr ""
"Primero tienes que subir el certificado apropiado haciendo clic en el botón \"Subir certificado\".\n"
"            Asegúrese de que:"
...
msgstr ""
"Para un comportamiento de aplicación correcto sólo se pueden utilizar los valores {{vm.defaultRedirectUrl}}\n"
"            o {{vm.host}}. Se recomienda utilizar el primero."
...
msgstr ""
"Consulte el manual\n"
"              <a c8y-guide-href=\"users-guide/administration/\">User guide</a> si desea obtener más información al respecto."

msgid "For device type: {{deviceType}}"
msgstr "Para el tipo de dispositivo: {{deviceType}}"
...
"        otra expresión, p. ej. <var ng-non-bindable>{{ placeholderName }}</var>. Después podrá utilizar este \"placeholderName\" en los enlaces (bindings) manejados por Angular. También tiene una serie de funciones predefinidas\n"
"        a su disposición:"

msgid "Force not to use display"
msgstr "No forzar a usar pantalla"
...
msgstr ""
"No se encontró ningún usuario de dispositivo con nombres que empiezan por\n"
"        <strong>{{::vm.filtering.filters.username}}</strong>."
...
msgstr "Fragmento equivalente al valor"

msgid "Fragment exists"
msgstr "El fragmento ya existe"
...
msgstr "Puerta_Aceleración"

msgid "Gateway_Battery"
msgstr "Puerta_Batería"

msgid "Gateway_Humidity"
msgstr "Puerta_Humedad"

msgid "Gateway_Magnetic_Switch"
msgstr "Puerta_magnética_cambiar"

msgid "Gateway_Signal"
msgstr "Puerts_Señal"

msgid "Gateway_Speed"
msgstr "Puerta_Velocidad"

msgid "Gateway_Temperature"
msgstr "Puerta_Temperatura"
...
msgstr "Registro general de dispositivos"
...
msgstr "Obtener PPPoE (protegido contra escritura)"
...
msgstr "Obtener nueva instantánea del dispositivo"
...
msgstr "Obtenga un comando predefinido"
...
msgstr "Obtener mediciones del dispositivo..."
...
msgstr "Da acceso a operaciones en masa y a la aplicación de gestión de dispositivos. Esto no incluye el acceso a ningún dato del dispositivo."
...
msgstr "ID de aplicación global"
...
msgstr "Ir al grupo \"Teléfonos inteligentes\""

msgid "Go to OpenCellID and see location"
msgstr "Ir a OpenCellID y ver ubicación"

msgid "Go to Smartphones group"
msgstr "Ir al grupo Teléfonos inteligentes"

msgid "Go to device"
msgstr "Ir a dispositivo"
...
msgstr "Consiguió las medidas del dispositivo."
...
msgstr "Tiene acceso completo a todos los módulos CEP desplegados y SmartRules"

msgid "Has right to"
msgstr "Tiene derecho a"
...
msgstr "Modo GPS pesado"

msgid "Height for setting the right proportion for the logo: width / height x 100"
msgstr "Altura para establecer la proporción correcta para la insignia: ancho / altura x 100"

msgid "Height for setting the right proportion for the navigator logo: width / height x 100 - should be 230px wide"
msgstr "Altura para establecer la proporción correcta para el logotipo del navegador: ancho / altura x 100-debe ser 230px amplia"
...
msgstr "Ocultar detalles de operación"
...
"                  hour."
msgstr ""
"Por hora: {{ schedule.cronConfig.minute | number: '2.0-0' }} minuto(s) pasada la\n"
"                  hora."
...
msgstr "Prefijo del nombre del grupo IMPACT"

msgid "IMPACT provider settings"
msgstr "Configuración del proveedor IMPACT"
...
msgstr "Si se ha aplicado OAuth Internal, ya no podrá utilizarse Basic Auth para iniciar aplicaciones. Puede que aplicaciones antiguas ya no se muestren correctamente y tengan que actualizarse."

msgid ""
"If no constraints are set, device types are applied at any fitting location on the OPC UA\n"
"      server."
msgstr ""
"Si no se ha configurado ninguna restricción los tipos de dispositivo se aplican en\n"
"      cualquier ubicación del servidor OPC UA."
...
msgstr ""
"Si cambia la configuración de pago ahora,<br>\n"
"         esta cantidad se liquidará inmediatamente."
...
msgstr "Si selecciona la configuración actual como predeterminada, estos valores se utilizarán siempre que este punto de datos se agregue a un explorador de datos o a un umbral existente de reglas inteligentes que hagan referencia a dicho punto de datos."
...
msgstr "Incluya caracteres en minúsculas (por ejemplo abcdef)"

msgid "Include numbers (e.g. 123456)"
msgstr "Incluya números (p. ej. 123456)"

msgid "Include symbols (e.g. !@#$%^)"
msgstr "Incluya símbolos (p. ej. !@#$%^)"

msgid "Include uppercase characters (e.g. ABCDEF)"
msgstr "Incluya caracteres en mayúsculas (por ejemplo, ABCDEF)"
...
msgstr "Incrementar la temperatura"

msgid "Index"
msgstr "Índice"

msgid "Indicate from where the value should be extracted"
msgstr "Indicar de donde se extraerá el valor"
...
msgstr "Insertar el código proporcionado por el inquilino de origen."
...
msgstr "Introduzca el tipo de funcionamiento personalizado apoyado por tu simulador"

msgid "Inspect"
msgstr "Verifique"

msgid "Inspect smart rule"
msgstr "Inspeccione la regla inteligente"
...
"        on your smartphone"
msgstr ""
"Instale la aplicación Cloud Sensor <br>\n"
...
msgstr "Instancias/Inquilinos suscritos"
...
msgstr "Número de teléfono internacional necesario, en el formato + 49 9 876 543 210."
...
msgstr "Dirección MAC no válida. Ejemplo: 12:34:56:AB:CD:EF"
...
msgstr "Formato de número de teléfono no válido. Sólo dígitos, espacios, barras diagonales (\"/\") y guiones (\"-\") permitido."

msgid "Invalid port number."
msgstr "Número de puerto no válido."

msgid "Invalid verification code. In case of key loss, please contact your platform administrator."
msgstr "Código de verificación no válido. Póngase en contacto con su administrador de plataforma si ha perdido su clave."
...
msgstr "Estructura de sincronización de inventario en curso"

msgid "Inventory update failed due to: \"{{failureReason | translate}}\"."
msgstr "El inventario no ha podido actualizarse debido a: \"{{failureReason | translate}}\"."

msgid "Inventory update failed."
msgstr "Error al actualizar el inventario."

msgid "Inventory updated."
msgstr "Inventario actualizado."

msgid "Inventory will be updated."
msgstr "El inventario se actualizará."
...
msgstr ""
"No es posible agregar nuevos horarios ni editar los existentes. Dispóngase a migrar\n"
"                    al nuevo componente."
...
msgstr "LED se desactivará."

msgid "LED will be turned on."
msgstr "LED se activará."
...
msgstr "Última facturación y cierre de cuenta"

msgid "Last clusters calculation time: {{lastCalculation | absoluteDate}}"
msgstr "Tiempo de cálculo del último clúster: {{lastCalculation | absoluteDate}}"
...
msgstr "Última modificación: {{vm.module.lastModified | absoluteDate}}"
...
msgstr "Deje en blanco para saltar esta restricción"

msgid "Leave empty to use value from tenant options"
msgstr "Deje en blanco para utilizar valores de opciones de inquilino"
...
msgstr "Limitar alcance de tipo de dispositivo en el espacio de dirección"

msgid "Limit device type to a set of servers"
msgstr "Limitar tipo de dispositivo a un conjunto de servidores"

msgid "Limit device type to servers with a certain fragment"
msgstr "Limitar tipo de dispositivo a servidores con un fragmento determinado"

msgid "Limit device type to specific root nodes ID"
msgstr "Limitar tipos de dispositivo a ID determinados de nodos raíz"
...
msgstr "Limite la validez de contraseña para"
...
msgstr "Limitar la validez del token para"

msgid "Limit verification code validity for"
msgstr "Limitar la validez del código de verificación para"
...
msgstr "Ajustes del proveedor LoRa"

msgid "Load"
msgstr "Cargar"

msgid "Load \"{{ kpi.c8y_Kpi.label }}\" from library"
msgstr "Cargar \"{{ kpi.c8y_Kpi.label }}\" desde la biblioteca"

msgid "Load from file"
msgstr "Cargar desde archivo"

msgid "Load from library"
msgstr "Cargar desde la biblioteca"
...
msgstr "Cargando la lista de elementos que desea eliminar &hellip;"

msgid "Loading users&hellip;"
msgstr "Cargando usuarios&hellip;"
...
msgstr "Bloquear/desbloquear este cuadro de mando"
...
msgstr "Conéctese primero al inquilino de gestión e introduzca su número de teléfono."
...
msgstr "Logger_Humidity"

msgid "Logger_Signal"
msgstr "Logger_Signal"

msgid "Logger_Temperature"
msgstr "Logger_Temperature"
...
msgstr "Configuración de inicio de sesión guardada."
...
msgid "Low mode"
msgstr "Modo de baja intensidad"

msgid "Low mode GPS"
msgstr "Modo GPS bajo"

msgid "Lua plugins settings"
msgstr "Configuración de plugins Lua"
...
msgstr "La diferencia principal es el almacenamiento de la información de autenticación. Con Basic Auth se guarda en un almacenamiento de sesión y con OAuth Internal en un HttpOnly cookie. La concesión OAuth Internal se recomienda cuando pueda accederse a la información de autenticación mediante JavaScript."
...
msgstr "Mantenimiento desactivado"

msgid "Maintenance on"
msgstr "Mantenimiento activado"

msgid "Major"
msgstr "Mayor"

msgid "Major alarms"
msgstr "Alarmas importantes"
...
msgstr "Sólo se permiten 25 caracteres como máximo: números, letras, espacios y signos de exclamación."
...
msgstr "Número máximo de simuladores alcanzado."

msgid "Maximum of simulated devices reached."
msgstr "Llegó a un máximo de dispositivos simulados."
...
msgstr "Puede contener letras minúsculas, dígitos o guiones. Debe empezar por una letra; el primer y el último carácter no pueden ser guiones; la longitud mínima es de 2 caracteres. Tenga en cuenta que los subrayados están en desuso pero se mantienen por razones de compatibilidad con versiones anteriores."
...
msgstr "Sólo se admiten letras, dígitos, guiones y subrayados. Debe empezar con una letra. El primer y el último carácter no pueden ser guiones ni subrayados. Debe tener como mínimo 2 caracteres."
...
msgstr "La ID del mensaje debe ser única entre todas las plantillas de mensaje y respuesta."
...
msgstr "Mensaje con el ID \"{{messageId}}\" no existe en la plantilla SmartREST con ID \"{{templateId}}\""
...
msgstr "El proveedor de mensajería debe configurarse para enviar configuración WAN al dispositivo a través de SMS"
...
msgstr "Migrar horarios de exportación"

msgid "Migrate later"
msgstr "Migrar posteriormente"
...
msgstr "La migración no ha podido efectuarse. Vuelva a intentarlo."
...
msgstr "Módulo \"{{name}}\" cambiado de nombre."

msgid "Module \"{{name}}\" saved."
msgstr "Módulo \"{{name}}\" guardado."
...
"                  }}."
msgstr ""
"Por mes: el {{ cronService.getMonthDayName(schedule.cronConfig) }} día del mes,\n"
"                  a las {{ schedule.cronConfig.hour | number: '2.0-0' }}:{{\n"
"                    schedule.cronConfig.minute | number: '2.0-0'\n"
"                  }}."
...
msgstr "Más datos pueden estar disponibles"
...
msgid "Multi tenant"
msgstr "Inquilino múltiple"

msgid "Multiple"
msgstr "Múltiple"

msgid "Multiple deployment options"
msgstr "Múltiples opciones de implementación"
...
msgstr "Debe tratarse de una URL de HTTP(S) válida"
...
msgstr "Debe tratarse de un número hexadecimal válido (mayúsculas)."
...
msgstr "Logotipo del navegador"

msgid "Navigator logo height"
msgstr "Altura del logotipo de Navigator"
...
msgstr "Clave de sesión de red"

msgid "Network: download"
msgstr "Red: descargar"
...
msgstr "Nueva plantilla de comando"
...
msgstr "Nuevo punto de datos"

msgid "New data point settings"
msgstr "Nueva configuración de punto de datos"
...
msgstr "Nueva regla inteligente global"
...
msgid "New tenant"
msgstr "Nuevo inquilino"

msgid "New tenant policy"
msgstr "Nueva política de inquilino"

msgid "New tenant policy description"
msgstr "Nueva descripción de la política del inquilino"
...
msgstr "Siguiente paso: registrar teléfono inteligente"
...
msgstr "No se encuentra configuración de proveedor de LoRa. Por favor configure los ajustes de conectividad."
...
msgstr "Ningún tipo de dispositivo Sigfox configurado. Cree uno utilizando base de datos del dispositivo."

msgid "No SmartREST templates defined yet."
msgstr "Todavía no hay plantillas SmartREST definidas."
...
msgstr "No se han encontrado activos o dispositivos para \"{{searchData.lastText}}\"."

msgid "No assets or devices found."
msgstr "No se han encontrado activos ni dispositivos."

msgid "No audit logs found."
msgstr "No se ha encontrado ningún archivo de registro de auditorá."

msgid "No borders"
msgstr "Sin bordes"

msgid "No bulk operations found."
msgstr "No se ha encontrado ninguna operación en masa."
...
msgstr "No hay planes de conectividad con ranuras libres disponibles."

msgid "No contracts available."
msgstr "Ningún contrato disponible."
...
msgstr "No hay perfiles de dispositivos."

msgid "No device protocols to display"
msgstr "No hay protocolos de dispositivo para mostrar"

msgid "No device types configured. Create a LoRa device type using device database."
msgstr "Ningún tipo de dispositivo configurado. Crear un dispositivo de tipo LoRa utilizando base de datos del dispositivo."
...
msgstr "Sin dispositivos encontrados."
...
msgstr "Sin módulos de procesamiento de evento encontrados"
...
msgstr "No se encontraron archivos que contengan <strong>{{ vm.searchString }}</strong>."
...
msgstr "No hay información de firmware disponible."

msgid "No firmwares to display."
msgstr "No hay firmwares para mostrar."

msgid "No footer"
msgstr "No pie de página"

msgid "No global roles found."
msgstr "No se ha encontrado ningún rol global."
...
msgstr "No hay eventos entrantes por el momento."
...
msgstr "No hay coincidencias. ¿Desea agregar una nueva configuración?"
...
msgstr "Sin estadísticas disponibles"

msgid "No more data found."
msgstr "No se han encontrado más datos."

msgid "No more entries found for filter:"
msgstr "No se han encontrado más entradas para el filtro:"
...
msgstr "No hay notificaciones aún recibidas"
...
msgstr ""
"Todavía no ha seleccionado ningún método de pago.<br>\n"
"      Seleccione la forma de pago ahora."

msgid "No pending registrations to display."
msgstr "Sin registros pendientes que mostrar."

msgid "No permissions for this scope."
msgstr "No hay permisos para este ámbito."

msgid "No permissions for user."
msgstr "No hay permisos para usuario."
...
msgstr "No hay recursos que mostrar. Haga clic a continuación para agregar."
...
msgstr "No hay sensores disponibles."

msgid "No sessions found."
msgstr "No se ha encontafo ninguna sesión."

msgid "No simulated devices available."
msgstr "No hay dispositivos simulados disponibles."

msgid "No simulators created yet"
msgstr "No hay simuladores creados todavía"
...
"        repository."
msgstr ""
"No hay captura asignada a este dispositivo. Obtener la instantánea actual de dispositivo o poner una nueva desde el\n"
"        depósito."
...
"      repository."
msgstr ""
"No hay ninguna instantánea asignada a este dispositivo. Obtenga la instantánea actual del dispositivo o coloque una nueva\n"
"      a partir del depósito."

msgid "No software available on the device"
msgstr "No hay software disponible en el dispositivo"
...
msgstr "No hay políticas de inquilino para mostrar"

msgid "No tenants to display."
msgstr "Sin inquilinos para mostrar."
...
msgstr "No se ha definido ninguna regla de validación."
...
msgstr "Ninguna variable que pueda mostrarse. Haga clic a continuación para agregar alguna."
...
msgstr "Tenga en cuenta que los dispositivos con largos intervalos de comunicación entrarán en modo reposo debido a su inactividad. Si éste fuera el caso, no podrá ejecutar ningún comando durante todo este período. Para salir del modo reposo debe cargar el dispositivo."

msgid "Note that email is required to reset password."
msgstr "Tenga en cuenta que hay que especificar el correo electrónico para restablecer la contraseña."
...
msgstr ""
"Nota: Al seleccionar \"Todos los objetos\" se sincronizarán todos los tipos de objeto,\n"
"                    incluidos los internos y técnicos (no sólo grupos y dispositivos).\n"
"                    Esto puede causar problemas en el inquilino de destino."

msgid "Note: Sorting might not work properly until all rows are loaded"
msgstr "Nota: la clasificación podría no funcionar correctamente hasta que se carguen todas las filas"
...
msgstr "Número de casos: {{vm.simulator.instances}}"
...
msgstr "Tipo de fragmento del objeto (p. ej. c8y_IsDevice) al que usted otorga permiso. Tenga en cuenta que para tener acceso a un objeto, el usuario tiene que tener acceso a todos sus fragmentos. Use un asterisco (*) para otorgar el permiso al tipo de fragmento de cualquier objeto."
...
msgid "On alarm"
msgstr "Alarma encendida"

msgid "On alarm duration"
msgstr "Duración de alarma"

msgid "On alarm matching:"
msgstr "Coincidencia de alarma:"
...
msgstr "Crear alarma en geofence"

msgid "On geofence send email"
msgstr "Enviar correo en geofence"

msgid "On geofence violation:"
msgstr "Violación de la Geofence:"

msgid "On high temperature raise alarms"
msgstr "En temperatura alta liberar alarmas"

msgid "On leaving"
msgstr "A la salida"

msgid "On measurement explicit threshold"
msgstr "En umbral explícito de medición"

msgid "On measurement threshold"
msgstr "Sobre el umbral de medición"
...
msgstr ""
"A la izquierda puede introducir un conjunto de comandos shell de LWM2M. Cada uno de\n"
"      estos comandos se enviará al dispositivo de LWM2M que acaba de registrar."
...
msgstr "Liberar alarmas cuando hay temperaturas muy altas"

msgid "On very high temperature send SMS"
msgstr "En temperaturas muy altas enviar un SMS"

msgid "On very high temperature send email"
msgstr "Enviar correo si la temperatura es muy elevada"
...
msgstr[1] "{{$count}} dispositivos conectados."

msgid "One device failed to connect."
msgid_plural "{{$count}} devices failed to connect."
msgstr[0] "Uno de los dispositivos no ha podido conectarse."
msgstr[1] "{{$count}} dispositivos no han podido conectarse."

msgid "Online"
msgstr "En línea"

msgid "Online / Server platform"
msgstr "Online / Plataforma de servidor"
...
msgstr "Solo se permiten letras y dígitos."
...
msgstr "Sólo se permiten números, p. ej. 1528197925677."
...
msgstr "Sólo valores enteros de minutos u horas son válidos."
...
"            smartphone."
msgstr ""
"Abra <strong>Google Play Store</strong> o <strong>Apple App Store</strong> en su\n"
...
msgstr "Abrir en Gestión de dispositivos"

msgid "Open in repository"
msgstr "Abierto en el depósito"
...
msgstr ""
"Abra la aplicación Cloud Sensor y efectúe el registro manual del dispositivo con la opción correspondiente.\n"
"        El registro automático en teléfonos inteligentes no está admitido en la versión de inicio de sesión único."

msgid "Open the Cloud Sensor App on your smartphone and scan the QR code below."
msgstr "Abra la aplicación Cloud Sensor en su teléfono inteligente y escanee el código QR que aparece a continuación."
...
msgstr "Cancelación de la operación activada. Si está en curso, puede tardar hasta un minuto para cancelarla."
...
msgstr "La operación falló. Modo avión no establecido."
...
msgstr "Orden de alarmas por la gravedad y el tiempo"
...
msgid "Parent tenant"
msgstr "Inquilino de los padres"
...
msgid "Pass strength"
msgstr "Fuerza del pase"

msgid "Password"
msgstr "Contraseña"

msgid "Password change confirmation email template"
msgstr "Plantilla de correo para restablecer contraseña"
...
msgstr "La contraseña debe tener al menos {{min}} caracteres y no más de {{max}} y sólo puede contener letras, números y los símbolos siguientes: `~!@#$%^&*()_|+-=?;:'\",.<>{}[]\\/"

msgid "Password not good enough, password must be be stronger (green)."
msgstr "Contraseña no lo suficientemente buena, la contraseña debe ser más fuerte (verde)."
...
msgstr "Plantilla de correo para restablecer contraseña (cuando se conoce la dirección)"

msgid "Password reset email template (when address is not known)"
msgstr "Plantilla de correo para restablecer contraseña (cuando no se conoce la dirección)"
...
msgstr "Límite de validez de la contraseña (días)"
...
msgstr "Pegar cuadro de mando \"{{name}}\""

msgid "Paste the certificate in PEM format here (required)"
msgstr "Pegar aquí el certificado en formato PEM (obligatorio)"
...
msgid "Pause device"
msgstr "Pausar dispositivo"

msgid "Payment contract ID"
msgstr "ID de contrato de pago"

msgid "Payment method"
msgstr "Método de pago"

msgid "Payment method changed."
msgstr "Método de pago cambiado."
...
msgstr "Elija su regla inteligente"
...
msgstr "Marcador de posición: {tenant} - ID del inquilino bloqueado; {tenant-domain} - dominio de inquilino"
...
msgstr "Marcadores de posición: {host}, {tenant-domain}"
...
msgstr "Marcadores de posición: {tenant-domain}, {host}, {token}, {email}. Por ejemplo, el enlace completo para restablecer la contraseña puede ser: {tenant-domain}/apps/devicemanagement/index.html?token={token}&email={email}"
...
msgstr "Marcadores de posicion: {tenant-domain}, {host}, {token}. El enlace completo para configurar la contraseña puede ser, p. ej. : {tenant-domain}/apps/devicemanagement/index.html?token={token}"

msgid "Placeholders: {user}, {exportApi}"
msgstr "Marcadores de posición: {user}, {exportApi}"

msgid "Placing order"
msgstr "Realizando pedido"

msgid "Platform application cannot be added to, nor removed from any tenant."
msgstr "Aplicación de plataforma no añadido, ni removido de cualquier inquilino."
...
msgstr "Por favor cumpla con 4 o 5 de las condiciones siguientes"
...
msgstr "Ventana emergente no se pudo abrir. Confirme la configuración del explorador."
...
msgstr "Valores posibles: \"true\", \"false\", fecha hasta la que el usuario debe permanecer activo"
...
"              smartphone."
msgstr ""
"Pulse <strong>Registro manual</strong> e introduzca los siguientes datos en su\n"
"              teléfono inteligente."

msgid "Press <strong>Scan QR code</strong> and use the code below."
msgstr "Pulse <strong>Escanear código QR</strong> y escanee el código indicado a continuación."
...
msgstr "Procesar cambios de software"
...
msgstr "Clave pública o ID"

msgid "Public key or identity"
msgstr "Clave pública o identidad"
...
msgstr "Contacte con nosotros por teléfono"
...
msgstr "Análisis de secuencias en tiempo real"
...
msgstr "Código de potencia de señal recibido"
...
msgstr "Referencia a otro objeto con este formato: /Objeto/Instancia/Recurso, p. ej. /3303/0/5700"
...
msgstr "Actualizar el estado del dispositivo"
...
msgstr "Registrar teléfono inteligente"
...
msgstr[0] "El registro no ha podido efectuarse para 1 dispositivo de un total de {{total}}."
msgstr[1] "El registro no ha podido efectuarse para {{$count}} dispositivos de un total de {{total}}."
...
msgstr[0] "1 dispositivo se ha registrado correctamente."
msgstr[1] "Registro efectuado correctamente para {{$count}} dispositivos."
...
msgstr "Operación de retransmisión"
...
msgstr "Quitar columna personalizada"
...
msgstr "Reemplazar credenciales"
...
msgstr "Solicitar registro del dispositivo"

msgid "Request device log"
msgstr "Solicitar registro de dispositivo"

msgid "Request inventory update"
msgstr "Solicitar actualización de inventario"

msgid "Request log"
msgstr "Registro de peticiones"
...
msgstr "El intervalo requerido debe ser un número y no puede ser más de un año."
...
msgstr "Reprogramar operación"

msgid "Reseller licencing"
msgstr "Licencias para distribuidores"
...
msgstr "Restablecer configuración de identidad aplicada"
...
msgstr "Control de acceso basada en recursos"
...
msgstr ""
"Le garantizamos que sus datos personales no se guardan\n"
"            y únicamente accedemos a los datos de sensor de su teléfono inteligente."
...
msgstr "Restaurar cuadro de mando"

msgid "Restore default dashboard"
msgstr "Restaurar cuadro de mando predeterminado"
...
msgstr "Recuperar instantánea de la configuración"
...
msgid "Retry failed"
msgstr "Reintento fallido"

msgid ""
"Retry or <a href=\"mailto:support@cumulocity.com\">reach us</a> if you're not able to\n"
"            upgrade."
msgstr ""
"Vuelva a intentarlo o <a href=\"mailto:support@cumulocity.com\">Contáctenos</a> si no consigue\n"
"            actualizar."
...
msgstr "El rol no se puede eliminar porque está asignado a usuarios."
...
msgstr "Configuración del proveedor SIM"
...
msgstr "Guardar configuración TFA"
...
msgstr "Escanear y conectar dispositivos secundarios."

msgid "Scan the QR code"
msgstr "Escanear código QR"

msgid "Scan this QR code with your smartphone using the Google Authenticator app."
msgstr "Escanee este código QR con su teléfono inteligente utilizando la aplicación Google Authenticator."

msgid "ScanWLAN"
msgstr "ScanWLAN"

msgid "Schedule device restart every day at 1am"
msgstr "Programar reinicio del dispositivo todos los días a la 1:00"
...
msgstr "Operación en masa programada para completar la operación en dispositivos fallidos."
...
msgstr "Controlador de búsqueda"
...
msgstr "El código de seguridad se solicitará al inquilino de destino para establecer la conexión."
...
msgstr "Seleccionar una configuración de entre la lista de configuraciones compatibles con dispositivos"
...
msgstr "Seleccione un firmware de la lista."
...
msgstr "Seleccionar nuevo propietario"

msgid "Select a predefined command"
msgstr "Seleccione un comando predefinido"

msgid "Select a software from the list."
msgstr "Seleccione un software de la lista."

msgid "Select all"
msgstr "Seleccionar todos"

msgid "Select all Admin checkboxes"
msgstr "Seleccionar todos los permisos de administrador"

msgid "Select all Admin`checkboxes`"
msgstr "Seleccionar todos los permisos de administrador"

msgid "Select all Read checkboxes"
msgstr "Seleccionar todas las casillas de verificación Leer"

msgid "Select all Read`checkboxes`"
msgstr "Seleccionar todos los permisos de lectura"
...
msgstr "Seleccionar la instantánea de configuración que desea utilizar"

msgid "Select connectivity plan"
msgstr "Seleccionar plan de conectividad"

msgid "Select content style"
msgstr "Seleccionar estilo de contenido"
...
msgstr "Seleccionar país de residencia"
...
msgstr "Elija un estilo de cabecera"
...
msgstr "Compruebe si el valor está representado en formato little endian basado en valores de 8 bits."
...
msgstr "Seleccione un evento de cambio de ubicación una vez durante 60 segundos"
...
msgstr "Seleccione uno de los proveedores de dispositivos"
...
msgstr "Seleccionar o buscar usuario"
...
msgstr "Seleccionar lecturas de temperatura sobre 100 grados"

msgid "Select tenant"
msgstr "Seleccionar el inquilino"

msgid "Select text file with multiple Bluetooth MAC addresses. One address per line."
msgstr "Seleccione el archivo de texto con múltiples direcciones de Bluetooth de MAC. Una dirección por línea."
...
msgstr "Seleccione la aplicación que desea escuchar"

msgid "Select the configuration you want to preview"
msgstr "Seleccione la configuración que desea mostrar en la vista previa"

msgid "Select the gender of your hero…"
msgstr "Seleccione el sexo de su héroe…"

msgid "Select theme"
msgstr "Seleccionar tema"

msgid "Select to define the mapping of possible values into strings."
msgstr "Seleccionr para definir la asignación de posibles valores a cadenas."
...
msgstr "Seleccionar comprobador"

msgid "Select widget"
msgstr "Seleccionar widget"

msgid "Select your preferred payment method."
msgstr "Seleccione su forma de pago preferida."

msgid "Select..."
msgstr "Seleccionar..."

msgid "Selected file has invalid extension."
msgstr "El archivo seleccionado tiene una extensión no válida."
...
msgstr "Enviar un texto a la pantalla LCD."
...
msgstr "Envía alarmas que están activas desde 30 minutos al correo electrónico"

msgid ""
"Send an operation to restart the device. The process of restart can be monitored under\n"
"            the operations of the device."
msgstr ""
"Envíe una operación para reiniciar el dispositivo. El proceso de reinicio puede controlarse\n"
"             en las operaciones del dispositivo."

msgid ""
"Send an operation to show a particular message to the device. The device behavior is\n"
"            device dependent."
msgstr ""
"Envíe una operación para mostrar un mensaje concreto al dispositivo. El comportamiento del dispositivo\n"
"           depende del mismo."
...
msgstr ""
"Envíe una operación para iniciar o detener el seguimiento interno del dispositivo.El resultado del seguimiento\n"
"            depende del dispositivo utilizado. Puede crear más eventos o crear un archivo dentro del dispositivo."

msgid "Send an operation to switch a relay on or off."
msgstr "Envíe una operación para cambiar un retransmisión de encendido o apagado."

msgid "Send an operation to switch an array of relays on or off."
msgstr "Envíe una operación para cambiar una matriz de retransmisiones de encendido o apagado."
...
msgstr "Enviar configuración {{ configurationType }} al dispositivo {{ deviceName }}"
...
msgstr "Enviar correo electrónico al administrador del inquilino suspendido"
...
msgstr "Enviar nueva instantánea al dispositivo"
...
msgstr "Enviar operación para escanear y conectar dispositivos secundarios automáticamente"
...
msgstr "Enviar ventas a Zapier"

msgid "Send simulator temperature to Zapier"
msgstr "Enviar emulador de temperatura a Zapier"

msgid "Send text"
msgstr "Enviar texto"

msgid "Send text to LCD"
msgstr "Enviar texto a LCD"
...
msgstr "Enviando nueva instantánea al dispositivo"

msgid "Sensor smartphone dashboard"
msgstr "Cuadro de mando para teléfonos inteligentes con sensor"
...
msgstr "Enviar operación para aplicar configuración DCHP."
...
msgstr "Tiempo de creación de servidor"
...
msgstr "El agente de servidor no está disponible."

msgid "Server-side agents"
msgstr "Agentes de servidor"

msgid "Server-side agents settings"
msgstr "Configuración de servidor agentes"

msgid "Server-side agents settings saved."
msgstr "Configuración de agentes de servidor guardada."

msgid "Service monitoring"
msgstr "Supervisión del servicio"
...
msgstr "Configurar PPPoE (protegido contra escritura)"
...
msgstr "Establecer máximo crédito para"
...
msgstr "Configurar URL de servidor (https:// or mqtts://)"
...
msgstr "Mostrar selección de fecha"

msgid "Show details"
msgstr "Mostrar detalles"

msgid "Show devices in group"
msgstr "Mostrar dispositivos en grupo"

msgid "Show devices registered after"
msgstr "Mostrar dispositivos registrados después de"

msgid "Show devices where \"{{headerName}}\" contains:"
msgstr "Mostrar dispositivos cuando el \"{{headerName}}\" contiene:"

msgid "Show devices with IMEI"
msgstr "Mostrar dispositivos con IMEI"

msgid "Show devices with active"
msgstr "Mostrar dispositivos con dispositivos activos"

msgid "Show devices with maintenance status"
msgstr "Mostrar dispositivos con estado de mantenimiento"

msgid "Show devices with model"
msgstr "Mostrar dispositivos con modelo"

msgid "Show devices with name"
msgstr "Mostrar dispositivos con nombre"

msgid "Show devices with push status"
msgstr "Mostrar dispositivos con estado push"

msgid "Show devices with send status"
msgstr "Mostrar dispositivos con estado de envío"

msgid "Show devices with serial number"
msgstr "Mostrar dispositivos con número de serie"

msgid "Show devices with system ID"
msgstr "Mostrar dispositivos con ID de sistema"
...
msgstr "Mostrar detalles de operación"
...
msgstr[0] "Mostrando 1 dispositivo subordinado"
msgstr[1] "Mostrando {{$count}} dispositivos secundarios"

msgid "Showing 1 group"
msgid_plural "Showing {{$count}} groups"
msgstr[0] "Mostrando 1 grupo"
msgstr[1] "Mostrando {{$count}} grupos"
...
msgstr "Mostrando {{devices.length}}"

msgid "Showing {{devices.length}} items"
msgstr "Mostrando {{devices.length}} elementos"

msgid "Showing {{devices.length}} of {{totalDevices}}"
msgstr "Mostrando {{devices.length}} de {{totalDevices}}"

msgid "Showing {{itemsLength}} items"
msgstr "Mostrando {{itemsLength}} elementos"
...
msgstr "Sielaff OLM2 variante de Communications Gateway"

msgid "Sigfox"
msgstr "Sigfox"

msgid "Sigfox provider settings"
msgstr "Configuración del proveedor Sigfox"
...
msgstr "Barra oblicua, uno o dos puntos y espacio en blanco no permitidos"
...
msgstr "Plantilla de SmartREST con id \"{{templateId}}\" no existe"
...
msgstr "Instantánea asignada en"

msgid "Software"
msgstr "Software"

msgid "Software item deleted."
msgstr "Elemento de software eliminado."

msgid "Software item saved."
msgstr "Elemento de software guardado."

msgid "Software repository"
msgstr "Depósito de software"

msgid "Software to install"
msgstr "Software para instalar"
...
msgstr "Algunas entradas no son válidas. Compruebe los campos de entrada bordeados en rojo y seleccione por lo menos un punto de datos."
...
msgstr "Estado de inquilino de fuente"

msgid ""
"Specifying auto-apply constraints allows you to limit the scope where the device types are\n"
"      applied, for example by specifying a set of possible servers or node IDs."
msgstr ""
"La indicación de restricciones de aplicación automática le permite limitar el alcance de los tipos de\n"
"      dispositivo, por ejemplo indicando un conjunto de posibles servidores o IDs de nodo."

msgid "Split multiple Bluetooth MAC addresses with \";\""
msgstr "Divida múltiples direcciones MAC Bluetooth con “;”"
...
msgid "Starter Kit"
msgstr "Kit de arranque"

msgid "Starter kit - Full Battery"
msgstr "Kit de arranque - batería llena"

msgid "Starter kit - Low Battery"
msgstr "Kit de arranque - batería baja"

msgid "Starter kit logger data"
msgstr "Datos del registrador del kit de arranque"
...
msgstr "Paso <span class=\"badge badge-success\">1</span> de 2"

msgid "Step <span class=\"badge badge-success\">2</span> of 2"
msgstr "Paso <span class=\"badge badge-success\">2</span> de 2"
...
msgstr "Configuración demo almacenada"

msgid "Stream URL"
msgstr "URL del Streaming"
...
msgstr "La cadena es demasiado larga ({{viewValue.length}} chars), {{schema.maxLength}} es el número de caracteres máximo permitido."

msgid "String is too short ({{viewValue.length}} chars), minimum {{schema.minLength}}."
msgstr "La cadena es demasiado corta ({{viewValue.length}} chars), {{schema.minLength}} es el número de caracteres mínimo permitido."
...
msgstr "Suscripción en el inquilino de destino deshabilitada"

msgid "Subscription in destination tenant disabled and then connector suspended by source tenant"
msgstr "Suscripción en el inquilino de destino deshabilitada y, a continuación, conector suspendido por el inquilino de origen"

msgid "Subscription registration"
msgstr "Registrar suscripción"

msgid "Subtenants"
msgstr "Subinquilinos"

msgid "Successful"
msgstr "Correcto"

msgid "Sum of CPU daily usage in CPU milliseconds"
msgstr "Suma de uso diario de CPU en milisegundos"
...
msgstr "Archivos soportados: *.png, *.svg"

msgid "Supported operating systems"
msgstr "Sistemas operativos admitidos"

msgid "Supported operations"
msgstr "Operaciones de soporte"

msgid "Suspend tenant"
msgstr "Suspender inquilino"

msgid "Suspend`tenant`"
msgstr "Suspender"

msgid "Suspending tenants"
msgstr "Suspendiendo inquilinos"

msgid "Switch"
msgstr "Cambiar"

msgid "Switch a relay for a certain duration."
msgstr "Cambiar un retransmisión por un tiempo determinado."
...
msgstr "Cambie a la pestaña \"Control\" para ver el estado actual de la operación."
...
msgstr "Configuración TFA guardada."

msgid "TFA status"
msgstr "Estado TFA"

msgid "TOTP requires OAuth Internal login mode."
msgstr "TOTP requiere el modo de inicio de sesión OAuth Internal."
...
msgstr "TOTP secret no se ha activado. Sólo el usuario puede activarlo."
...
msgstr "Tabla de propiedades del dispositivo, por ejemplo nombre, tipo o notas."

msgid "Take your phone and click <strong>Next</strong>."
msgstr "Coja su teléfono y haga clic en <strong>Siguiente</strong>."
...
msgstr "Activos o dispositivos de destino"
...
msgstr "Temperatura disminuida en {{value}} ° C en \"{{deviceName}}\" en \"{{groupName}}\"."

msgid "Temperature increased by {{value}}°C on \"{{deviceName}}\" in \"{{groupName}}\"."
msgstr "Temperatura disminuida a {{value}} ° C en \"{{deviceName}}\" en \"{{groupName}}\"."

msgid "Temperature is higher than expected."
msgstr "La temperatura es mayor de lo esperado."

msgid "Temperature is much higher than expected."
msgstr "La temperatura es mucho mayor de lo esperado."
...
msgstr "Temperatura en dispositivo #{source.name} (id: #{source.id}) es mucho mayor de lo esperado."
...
msgstr "Inquilino \"{{tenant}}\" activado."

msgid "Tenant \"{{tenant}}\" created."
msgstr "Inquilino \"{{tenant}}\" creado."

msgid "Tenant \"{{tenant}}\" deleted."
msgstr "Inquilino \"{{tenant}}\" eliminado."

msgid "Tenant \"{{tenant}}\" suspended."
msgstr "Inquilino \"{{tenant}}\" suspendido."

msgid "Tenant \"{{tenant}}\" updated: {{properties}}."
msgstr "Inquilino \"{{tenant}}\" actualizado: {{properties}}."

msgid "Tenant ID"
msgstr "ID de inquilino"

msgid "Tenant Manager"
msgstr "Administrador de inquilino"

msgid "Tenant activated"
msgstr "Inquilino activado"

msgid "Tenant created"
msgstr "Inquilino que creado"

msgid "Tenant deleted"
msgstr "Inquilino eliminado"

msgid "Tenant deleted."
msgstr "Inquilino eliminado."

msgid "Tenant management"
msgstr "Gestión de inquilino"

msgid "Tenant options"
msgstr "Opciones de inquilino"

msgid "Tenant policies"
msgstr "Políticas de inquilino"

msgid "Tenant policy"
msgstr "Política de inquilino"

msgid "Tenant policy \"{{name}}\" deleted"
msgstr "Política de inquilino “{{name}}” borrada"

msgid "Tenant policy name changed to \"{{name}}\""
msgstr "El nombre de la política de inquilino cambió a \"{{name}}\""

msgid "Tenant saved."
msgstr "Inquilino guardado."

msgid "Tenant statistics"
msgstr "Estadísticas de inquilino"

msgid "Tenant suspended"
msgstr "Inquilino suspendido"

msgid "Tenant suspended email additional receiver"
msgstr "Receptor complementario del correo electrónico Inquilino suspendido"

msgid "Tenant suspended email subject"
msgstr "Asunto de correo electrónico Inquilino suspendido"

msgid "Tenant suspended email template"
msgstr "Plantilla de correo electrónico Inquilino suspendido"

msgid "Tenant updated"
msgstr "Inquilino actualizado"

msgid "Tenant updated."
msgstr "Inquilino actualizado."

msgid "Tenants"
msgstr "Los inquilinos"

msgid "Terminal configuration will be updated."
msgstr "La configuración de terminal se actualizará."
...
msgstr ""
"La configuración de 'Dominio permitido' permitirá que las aplicaciones Web JavaScript se comuniquen directamente con las API de REST.\n"
"Introduzca \"*\" para permitir la comunicación desde cualquier host.\n"
"Introduzca \"http://my.host.com, http://myother.host.com\" para permitir que aplicaciones se comuniquen con la plataforma desde http://my.host.com y dese http://myother.host.com.\n"
"Deje el campo vacío para permitir el acceso únicamente desde su dominio de inquilino.\n"
"Diríjase a http://enable-cors.org si desea obtener más información."
...
msgstr "El nombre elegido es demasiado largo. Por favor pruebe con uno más corto."
...
msgstr "El cuadro de mando tiene un fondo oscuro y alto contraste."

msgid "The dashboard is styled with a light background and has low contrast."
msgstr "El cuadro de mando tiene un fondo claro y bajo contraste."

msgid "The dashboard is styled with a transparent background and therefore is border-less."
msgstr "El cuadro de mando tiene un fondo transparente y por esta razón no tiene bordes."

msgid "The dashboard is styled with the main brand color."
msgstr "El cuadro de mando presenta el color de la marca principal."
...
msgstr ""
"La aplicación predeterminada se aplica a todos los usuarios del inquilino. Seleccione la aplicación predeterminada\n"
"          de la lista siguiente y asegúrese de que todos los usuarios tengan acceso a esta aplicación."
...
msgstr ""
"El ID externo enlaza la información del dispositivo con el mundo físico (por ejemplo: número de serie, IMEI).\n"
"\n"
...
msgstr "Se utilizará la siguiente información de contacto."
...
msgstr "La configuración siguiente se gestiona a nivel de plataforma."

msgid "The interval must be a positive value."
msgstr "El intervalo debe ser un valor positivo."
...
msgstr "El número de minutos debe ser estrictamente menor que 60 minutos. Por favor cambie a horas para los intervalos más grandes."
...
msgstr "El archivo seleccionado es demasiado grande. El tamaño máximo permitido es {{vm.fileSizeLimit | bytes}}."

msgid ""
"The snapshot with the ID {{ deviceConfigId }} is assigned to the device but the\n"
"        configuration can't be found in the repository."
msgstr ""
"La instantánea con el ID {{ deviceConfigId }} está asignada al dispositivo pero la configuración no\n"
"        ha podido encontrarse en el depósito."

msgid ""
"The snapshot with the ID {{ deviceConfigId }} is assigned to the device but the configuration\n"
"      can't be found in the repository."
msgstr ""
"La instantánea con el ID {{ deviceConfigId }} está asignada al dispositivo pero la configuración\n"
"      no ha podido encontrarse en el depósito."
...
"          its children."
msgstr ""
"Al usuario se le garantiza el acceso a los grupos de dispositivo recogidos en una lista según los admiten los\n"
"          roles de inventario. Utilice el desplegable para seleccionar los roles que desea aplicar a cada grupo\n"
"          y sus secundarios."
...
msgstr "El widget tiene un fondo oscuro y alto contraste."

msgid "The widget is styled with a light background and has low contrast."
msgstr "El widget tiene un fondo claro y bajo contraste."

msgid "The widget is styled with a transparent background and therefore is border-less."
msgstr "El widget tiene un fondo transparente y por esta razón no tiene bordes."
...
msgstr "No hay asignaciones de alarma definidas"
...
msgstr "No hay ningún dispositivo secundario conectado."

msgid "There are no credentials provided yet. Please provide some."
msgstr "Todavía no hay credenciales proporcionadas. Por favor proporcione algunas."
...
msgstr "No hay puntos finales definidos."

msgid "There are no pending operations"
msgstr "Hay no hay operaciones pendientes"
...
msgstr "Hubo un problema procesando su pago.<br>Por favor actualice el método de pago."

msgid "There was an error processing the post-operations."
msgstr "Hubo un error procesando las post operaciones."
...
msgstr "Esta aplicación ya se ha asignado al inquilino \"{{tenant}}\"."
...
msgstr "Este cuadro de mando se muestra en todos los dispositivos del tipo"

msgid ""
"This dashboard is shared between all devices of the type\n"
"                  <i>{{ dashboard.deviceTypeValue }}</i>."
msgstr ""
"Este cuadro de mando se muestra en todos los dispositivos del tipo\n"
"                  <i>{{ dashboard.deviceTypeValue }}</i>."
...
msgstr "Esta ID externa no es única"
...
msgstr ""
"Esta característica está en desuso y se eliminará en la siguiente versión. Use en su lugar la característica\n"
"    <a href=\"/apps/devicemanagement/#/simulators\">nuevo simulador</a>."
...
msgstr ""
"Esta característica está en desuso. Sigue siendo completamente funcional pero es preferible utilizar los nuevos\n"
"         <a href=\"/apps/administration#roles\">Roles</a> para establecer los permisos."
...
msgstr "Esta característica es obsoleta. Aunque sigue siendo completamente funcional más bien debe usar <a href=\"/apps/administration#roles\">Roles</a> para establecer los permisos."
...
msgstr "Este grupo no está vacío. Quite primero sus secundarios."

msgid "This group no longer exists."
msgstr "Este grupo ya no existe."

msgid "This is a default configuration and cannot be changed."
msgstr "Esto es una configuración predeterminada y no se puede cambiar."

msgid "This is the current configuration and cannot be deleted."
msgstr "Esta es la configuración actual y no se puede eliminar."
...
msgstr "Este rol tiene acceso a la aplicación seleccionada aquí abajo."

msgid "This role is already assigned to a parent asset."
msgstr "Esta función ya está asignada a un activo paterno."
...
msgstr "Este ajuste permitirá recuperar todos los productos sin pago. ¿Estás seguro de que quieres activar Free vend?"
...
msgstr "Esto irá emparejado con la ID del mensaje encontrado en la fuente especificada en la página principal del tipo de dispositivo"

msgid ""
"This wizard will set up groups hierarchy, create simulated devices, configure dashboards and\n"
"      smart rules."
msgstr ""
"Este asistente permite configurar la jerarquía de grupos, crear dispositivos simulados y configurar cuadros de mando y\n"
"      reglas inteligentes."
...
msgstr "Para ver el resultado haga click <a href=\"#/device/{{deviceId}}/control\">aquí</a>"
...
msgstr "Modelo de unidad de seguimiento GPS elegida."
...
msgstr "Reproducción de seguimiento"
...
msgstr "Traducir títulos de extensiones si es posible"
...
msgid "Trial Tenant"
msgstr "Inquilino de prueba"

msgid "Trial expires in"
msgstr "Edición de rueba expira en"

msgid "Trial period started"
msgstr "Periodo de prueba empezado"
...
msgstr "Activar o desactivar LED."

msgid "Twitter news"
msgstr "Noticias de Twitter"
...
msgstr ""
"Las extensiones de escala de tiempo Twitter que dependen de la configuración de cuenta (véase <a href=\"https://twittercommunity.com/t/deprecating-widget-settings/102295\">announcement</a>).\n"
"  Puede utilizar la extensión HTML para incorporar escalas de tiempo con ayuda del código generado en <a href=\"https://publish.twitter.com\">Twitter Publish</a>."

msgid "Twitter's username"
msgstr "Nombre de usuario de Twitter"

msgid "Twitter's widget ID"
msgstr "ID del widget de Twitter"

msgid "Two-factor authentication"
msgstr "Autenticación en dos fases"
...
msgstr "Escritura independiente"
...
msgstr "La opción de inquilino no ha podido obtenerse: \"{{option}}\"."
...
msgstr "Desmarcar todo lo visible"
...
msgstr "Identificador de interfaz único de SGI"
...
msgstr "Actualizar \"{{ getLinkedKpiLabel() }}\" en la biblioteca"

msgid "Update a fragment in managed object whenever the value is changed"
msgstr "Actualizar un fragmento de objeto administrado cada vez que se cambia el valor"
...
msgstr "Actualizar el software del dispositivo."

msgid "Update firmware to: {{name}} (version: {{version}})."
msgstr "Actualizar firmware a: {{name}} (version: {{version}})."

msgid "Update managed object"
msgstr "Actualización de objeto administrado"

msgid "Update maximum credit"
msgstr "Actualizar crédito máximo"

msgid "Update protocol configuration"
msgstr "Configuración del Protocolo de actualización"
...
msgstr "Actualizar la máquina expendedora"
...
msgstr "Actualizar a Inquilino de empresa"

msgid "Upgrade to Standard Tenant"
msgstr "Actualizar a Inquilino predeterminado"
...
msgstr "Subir archivo a dispositivo de registro en masa"

msgid "Upload a text file"
msgstr "Subir un archivo de texto"
...
msgstr "Usar DDCMP lista #2, #2 RS232"

msgid "Use DDCMP list 2 on RS232 #1"
msgstr "Utilizar lista DDCMP 2 RS232 # 1"
...
msgstr "Uso mejorado DDCMP @ 2400 en RS232 #1"
...
msgstr "Utilizar configuración como predeterminada"
...
msgstr "Utilice al asistente para registrar un nuevo dispositivo."
...
"            Sensor App."
msgstr ""
"Utilice este asistente para conectar su teléfono inteligente con la plataforma Cumulocity IoT mediante la aplicación\n"
...
msgstr "Nombre de usuario (p. ej. correo electrónico)"
...
"            Cumulocity IoT."
msgstr ""
"El uso de su teléfono inteligente como fuente de datos de sensor es una manera rápida de aprender a utilizar\n"
"            Cumulocity IoT."
...
msgstr "Valor para activos"

msgid "Value for inactive"
msgstr "El valor de inactivos"
...
msgstr "El valor {{viewValue}} es superior al máximo permitido {{schema.maximum}}."

msgid "Value {{viewValue}} is less than minimum {{schema.minimum}}."
msgstr "El valor {{viewValue}} es inferior al mínimo permitido {{schema.minimum}}."
...
msgstr "Valores separados por punto y coma, por ejemplo:"
...
msgstr "Configuración de la máquina expendedora"
...
msgstr "Temperatura muy alta detectada."
...
msgstr "Espere mientras se cargan los grupos para el inquilino actual &hellip;"

msgid "Wait while provider settings are loaded&hellip;"
msgstr "Espere mientras se cargan ajustes de proveedor &hellip;"

msgid "Wait while providers are loaded"
msgstr "Espere mientras se cargan los proveedores"

msgid "Wait while settings are loaded&hellip;"
msgstr "Espere mientras se cargan ajustes &hellip;"
...
msgstr "Esperando a que se complete la instalación de la suscripción de datos …"

msgid "Waiting in queue"
msgstr "Esperando en cola"

msgid "Wake device on move"
msgstr "Dispositivo de activación en movimiento"

msgid "Wake device on shock"
msgstr "Dispositivo de reactivación en shock"
...
msgstr "Asunto del correo electrónico de alerta"
...
msgstr "Alerta: se seleccionan las medidas con diferentes unidades."
...
msgstr "Utilizaremos la información proporcionada en el siguiente ciclo de facturación."
...
msgstr ""
"En el siguiente período de facturación usaremos la información<br>\n"
"            facilitada. Dicho período empieza el \n"
"            {{ vm.resolve.contractInfo.NextBillingDate | absoluteDateTimeFormat: 'll' }}."
...
"                  }}."
msgstr ""
"Por semana: los {{ cronService.getWeekDayName(schedule.cronConfig) }}, a las\n"
"                  {{ schedule.cronConfig.hour | number: '2.0-0' }}:{{\n"
"                    schedule.cronConfig.minute | number: '2.0-0'\n"
"                  }}."
...
msgstr "Bienvenido a administración"

msgid "Welcome to Cockpit"
msgstr "Bienvenido a Cockpit"

msgid "Welcome to {{vm.appName | humanizeAppName}}"
msgstr "Bienvenido a {{vm.appName | humanizeAppName}}"

msgid "What is the name of your hero?"
msgstr "¿Cuál es su superhéroe favorito?"

msgid "What is the special ability of your hero?"
msgstr "¿Cuál es la habilidad especial de su héroe?"
...
msgstr "Al hacer clic en Aceptar, acepta que un usuario de soporte tenga acceso a su inquilino para ayudarle con su problema específico."
...
msgstr "Cuadro de mando de widget"
...
msgstr "Widget para la retransmisión de conmtación"
...
"                  }}."
msgstr ""
"Por año: {{ cronService.getMonthName(schedule.cronConfig) }}, el\n"
"                  {{ cronService.getMonthDayName(schedule.cronConfig) }} día del mes, a las\n"
"                  {{ schedule.cronConfig.hour | number: '2.0-0' }}:{{\n"
"                    schedule.cronConfig.minute | number: '2.0-0'\n"
"                  }}."
...
msgstr "Gama de amarillo: {{min}} … {{max}}"
...
msgstr "Se dispone a facilitar el acceso de un usuario de soporte de {{companyName}} a su inquilino para ayudarle con su problema."

msgid "You are about to allow a support user to access your tenant to help you with your issue."
msgstr "Se dispone a facilitar el acceso de un usuario de soporte a su inquilino para ayudarle con su problema."

msgid "You are about to apply the branding configuration, making it visible to all subtenants. Do you want to proceed?"
msgstr "Se dispone a aplicar la configuración de identidad haciéndola visible para todos los subinquilinos. ¿Desea continuar?"

msgid "You are about to block a support user from accessing your tenant to help you with your issue."
msgstr "Se dispone a bloquear el acceso de un usuario de soporte a su inquilino para ayudarle con su problema."

msgid "You are about to block a support user from {{companyName}} from accessing your tenant to help you with your issue."
msgstr "Se dispone a bloquear el acceso de un usuario de soporte de la compañía {{companyName}} a su inquilino para ayudarle con su problema."
...
msgstr "Se dispone a cerrar su cuenta. ¿Desea continuar?"
...
"        2 minutes."
msgstr ""
"Se dispone a crear versiones con identidad de marca de aplicaciones estándar. Esta operación puede durar\n"
"        2 minutos."
...
msgstr ""
"Se dispone a eliminar las credenciales de proveedor de SMS. Si lo hace bloqueará a los usuarios\n"
"      con la autenticación de dos factores basada en SMS y desactivará las reglas inteligentes basadas en SMS y la comunicación del dispositivo.\n"
"      ¿Desea continuar?"
...
msgstr "Se dispone a eliminar el punto de datos \"{{kpiLabel}}\". ¿Desea continuar?"
...
msgstr "Se dispone a eliminar el elemento de firmware \"{{name}}\". ¿Desea continuar?"
...
msgstr "Se dispone a eliminar el grupo \"{{name}}\" y sus subgrupos de forma recursiva. Esta operación es irreversible. ¿Desea continuar?"

msgid "You are about to delete group \"{{name}}\". Do you want to proceed?"
msgstr "Se dispone a eliminar el grupo \"{{name}}\". ¿Desea continuar?"
...
msgstr "Se dispone a eliminar el informe \"{{name}}\". ¿Desea continuar?"
...
msgstr "Se dispone a eliminar el elemento de software \"{{name}}\". ¿Desea continuar?"
...
msgstr "Se dispone a eliminar el inquilino \"{{company}}\" (ID \"{{id}}\"). ¿Desea continuar?"
...
msgstr "Se dispone a eliminar la configuración actual. ¿Desea continuar?"
...
msgstr "Se dispone a eliminar el cuadro de mando \"{{name}}\" de todos los dispositivos del tipo \"{{deviceTypeValue}}\". ¿Desea continuar?"

msgid "You are about to delete the dashboard \"{{name}}\". Do you want to proceed?"
msgstr "Se dispone a eliminar el cuadro de mando \"{{name}}\". ¿Desea continuar?"
...
msgstr "Se dispone a eliminar el rol global \"{{name}}\". ¿Desea continuar?"

msgid "You are about to delete the module \"{{name}}\". Do you want to proceed?"
msgstr "Se dispone a eliminar el módulo \"{{name}}\". ¿Desea continuar?"

msgid "You are about to delete the resource with the ID \"{{id}}\". Do you want to proceed?"
msgstr "Se dispone a eliminar el recurso con el ID \"{{id}}\". ¿Desea continuar?"

msgid "You are about to delete the schedule \"{{subject}}\". Do you want to proceed?"
msgstr "Se dispone a eliminar el horario \"{{subject}}\". ¿Desea continuar?"
...
msgstr "Se dispone a eliminar el rol global. Introduzca \"{{ ctrl.randomString }}\" para confirmar:"
...
"          Do you want to proceed?"
msgstr ""
"Se dispone a cargar los datos de registro guardados en {{ temporaryRegistration.timestamp }}.\n"
"          ¿Desea continuar?"
...
msgstr "Se dispone a volver a cargar la aplicación para poder ver los cambios efectuados. ¿Desea continuar?"
...
msgstr ""
"Se dispone a restablecer la configuración de identidad aplicada.\n"
"        Si se habían definido opciones personalizadas previamente, éstas también se restablecerán.\n"
"        Todos los subinquilinos adoptarán la identidad predeterminada. ¿Desea continuar?"
...
msgstr "Se dispone a iniciar el procesamiento de cambios de software. Esta operación es asincrónica. ¿Desea continuar?"
...
msgstr "Se dispone a suspender el inquilino \"{{company}}\" (ID \"{{id}}\"). ¿Desea continuar?"
...
msgstr ""
"Actualmente está utilizando una versión de prueba. Actualice para aprovechar\n"
"            plenamente la plataforma de IoT Cumulocity."

msgid "You can add device to specific group for management tenant only."
msgstr "Puede Agregar dispositivo a grupo específico sólo para cliente de gestión."
...
"          smartphone."
msgstr ""
"Puede comprobar sus datos de sensor en el cuadro de mando creado para este\n"
"          teléfono inteligente."

msgid "You can obtain Twitter's widget ID from <a href=\"https://twitter.com/settings/widgets\">Widgets Settings</a>."
msgstr "Puede obtener widget ID de Twitter de <a href=\"https://twitter.com/settings/widgets\">Configuración de Widgets</a>."
...
msgstr "Debe definirse por lo menos 1 instancia."

msgid "You have to define at most 5 instances."
msgstr "Como máximo deben definirse 5 instancias."
...
msgstr "Puede utilizar la siguiente sintaxis para indicar acciones posteriores al registro:"
...
msgstr "Usted debe agregar al menos un punto de datos."
...
msgstr "Debe activar por lo menos un punto de datos."
...
msgstr "Estos roles se requieren para acceder a operaciones en masa: Lectura/administración de operaciones en masa"
...
msgstr "Necesita estos roles para administrar la demostración: Lectura/administración de inventario, Administración de simulador, Lectura/administración de regla inteligente"
...
msgstr "Es necesario corregir los errores de validación antes de guardar."
...
"        registered."
msgstr ""
"Se ha alcanzado el número máximo permitido de {{ vm.limitStatus.limit }} dispositivos. No pueden registrarse\n"
"        más dispositivos."
...
msgstr ""
"Ha alcanzado el límite de {{ vm.limitStatus.limit }} dispositivos.<br>\n"
"        No se pueden registrar más dispositivos.<br>\n"
"        Póngase en contacto con su administrador de plataforma."
...
msgstr "Usted recibirá los links de descarga por correo."

msgid "Your Superhero is now ready to save the world!"
msgstr "¡Su superhéroe está listo para salvar el mundo!"

msgid "Your account has been closed."
msgstr "Su cuenta se ha cerrado."

msgid "Your account will be closed at the end of the current billing period."
msgstr "Su cuenta se cerrará al final del actual período de facturación."

msgid "Your branding and URL"
msgstr "Su Branding y URL"
...
msgstr "Su actualización fue completada con éxito."
...
msgstr "todos los tipos de objetos"
...
msgstr "c8y_MedidasDeAlarmaPerdidas"
...
msgstr "tipo de dispositivo=“{{deviceName}}”"
...
msgstr "p. ej. 46543432321, puede utilizar un asterisco (*) como carácter comodín"

msgid "e.g. 54321-123, you can use an asterisk (*) as wildcard character"
msgstr "p. ej. 54321-123, puede utilizar un asterisco (*) como carácter comodín"
...
msgstr "p. ej. Empresa Pablo García & hijos"
...
msgstr "por ejemplo el nombre del modelo, puede utilizar (*) como carácter comodín"

msgid "e.g. My Device, you can use an asterisk (*) as wildcard character"
msgstr "p. ej. Mi Dispositivo, puede utilizar (*) como carácter comodín"

msgid "e.g. My Impact protocol"
msgstr "p. ej. Mi protocolo IMPACT"
...
msgstr "p. ej. Mi configuración"

msgid "e.g. My configuration snapshot"
msgstr "p. ej. Mi instantánea de configuración"
...
msgstr "p. ej. Mi política de inquilino"

msgid "e.g. New York`LOCALIZE`"
msgstr "p.ej. Barcelona"
...
msgstr "p. ej. el texto que se desea mostrar"

msgid "e.g. Wall Street`LOCALIZE`"
msgstr "p. ej. Calle de Alcalá"

msgid "e.g. c8y.onmicrosoft.de"
msgstr "p. ej. c8y.onmicrosoft.es"
...
msgstr "p. ej., https://ejemplo.com/minormativa"

msgid "e.g. https://login.microsoftonline.de"
msgstr "p. ej. https://login.microsoftonline.es"

msgid "e.g. https://my-tenant.cumulocity.com/apps/cockpit"
msgstr "p. ej. https://mi-inquilino.cumulocity.com/apps/cockpit"

msgid "e.g. https://target-tenant.com"
msgstr "p. ej. https://target-tenant.com"
...
msgstr "p. ej. Mi_contraseña_actual"

msgid "e.g. my_new_password"
msgstr "p. ej. Mi_nueva_contraseña"
...
msgstr "p. ej. el texto que se desea buscar"
...
msgid "e.g.: #27b3ce"
msgstr "por ejemplo: #27b3ce"

msgid "e.g.: Verification code: {token}"
msgstr "por ejemplo: código de verificación: {token}"
...
msgstr "razón del fallo=\"{{failureReason | translate}}\""
...
msgstr "o haga clic para buscarlo en su ordenador."
...
msgstr "Con tecnología de Cumulocity"
...
msgstr "toma el ID del dispositivo y redirige al usuario a la vista de detalles del dispositivo, p. ej."

msgid "takes the group ID and redirects the user to the group details view, e.g."
msgstr "toma el ID del grupo y redirige al usuario a la vista de información de grupo, p. ej."
...
msgstr "el certificado se encuentra en un formato PKCS#12 válido"

msgid "the certificate is not password protected"
msgstr "el certificado no está protegido por contraseña"

msgid "the common name (domain name) is not used by any other tenant"
msgstr "el nombre común (nombre de dominio) no está siendo utilizado por ningún otro inquilino"
...
msgstr ""
"ha agregado una entrada CNAME a su servidor DNS. Asegúrese de que elimina todas las entradas A\n"
"              de su dominio comodín. Póngase en contacto con nuestro soporte técnico si su servicio DNS\n"
...
msgstr "está utilizando un certificado comodín para activar la creación de subinquilinos"
